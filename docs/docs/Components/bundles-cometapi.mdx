...
description: Use CometAPI models in Portals to generate text or output a Language Model for downstream Components.
---

import Icon from "@site/src/components/icon";

[Bundles](/components-bundle-components) contain custom components that support specific third-party integrations with Portals.
...
3. In Portals, add the **CometAPI** component to your flow.
