...
description: Instrument Portals with the Traceloop SDK, and export traces and metrics to Instana using OpenTelemetry.
---
...
This guide demonstrates how to integrate the Instana observability platform with your Portals application using the Traceloop SDK so you can monitor and analyze LLM performance.
...
1. In the root folder of your Portals application, edit your existing Portals `.env` file or create a new one.
...
## Start Portals with Traceloop environment variables

Launch your Portals application with your `.env` file:
...
1. Run a flow in Portals to generate traffic.
2. To view traces in Instana, open Instana and click **Applications**.
3. In **Services**, search for `Portals`.
4. Click **Portals** to view and analyze the associated calls.
