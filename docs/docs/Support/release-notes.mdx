...
- Portals MCP client for Bob (IBM) and Claude Code
    ...
    For more information, see [Portals MCP client for coding agents](../Agents/portals-mcp-client.mdx).
...
- Build components with **Portals Assistant**
    ...
    **Portals Assistant** is an in-app virtual assistant that can create components from natural language prompts directly within the Portals workspace.
