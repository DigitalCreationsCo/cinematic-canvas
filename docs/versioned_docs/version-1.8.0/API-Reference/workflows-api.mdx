...
The Workflow API provides programmatic access to execute Portals workflows synchronously or asynchronously.
...
The Workflow API is part of the Portals Developer v2 API and offers enhanced workflow execution capabilities compared to the v1 `/run` endpoint.
...
To find the component ID in the Portals UI, open your flow in Portals, click the component, and then click **Controls**. The component ID is at the top of the **Controls** pane.
