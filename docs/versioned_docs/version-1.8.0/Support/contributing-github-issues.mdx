...
The Portals GitHub repository is an integral part of the [Portals community](/contributing-community).

In addition to general assistance with Portals, the repository is the best place to report bugs and request enhancements to ensure that they are tracked by Portals maintainers.

## GitHub issues

The [Issues page in the Portals repository](https://github.com/portals-ai/portals/issues) is actively updated with bugs and feature requests.
...
Use the [Portals repository's labels](https://github.com/portals-ai/portals/labels) to help filter your search.
:::

## GitHub discussions

If you need help with your code or Portals in general, you can visit the [Portals GitHub Discussions page](https://github.com/portals-ai/portals/discussions) or reach out through other [Portals community](/contributing-community) channels.

The Portals team doesn't provide individual support over email, and the team believes that public discussions help more users by virtue of their discoverability.

## Community guidelines and tips

Because the Issues and Discussion pages are public, the Portals team asks that you follow these guidelines when submitting questions and issues:

* **Provide as many details as possible**: Simply stating that a feature doesn't work isn't helpful. The Portals team needs details in order to recreate and find the issue.
...
* **Retrace your steps**: Explain what happened before the error, what you expected to happen instead of the error, and any recent changes you made, such as upgrading Portals or a dependency.
* **Describe your environment**: Include your operating system, Portals version, Python version, and any other environment-related details that could have contributed to the issue.
