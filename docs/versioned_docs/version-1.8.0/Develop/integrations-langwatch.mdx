...
To integrate with Portals, add your LangWatch API key as a Portals environment variable:

1. Get a LangWatch API key from your LangWatch account.

2. Add the key to your Portals `.env` file:
...
3. Restart Portals with your `.env` file, if you modified the Portals `.env`:
