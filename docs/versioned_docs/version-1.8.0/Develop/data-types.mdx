...
The schema is defined in [`data.py`](https://github.com/portals-ai/portals/blob/main/src/backend/base/portals/schema/data.py).
...
The schema is defined in [`dataframe.py`](https://github.com/portals-ai/portals/blob/main/src/backend/base/portals/schema/dataframe.py).

The following attributes are available:

- **Full pandas compatibility**: All pandas DataFrame methods and functionality are supported

- **Portals integration**: Accepts lists of [`Data` objects](#data), dictionaries, or existing DataFrames.
...
The `Message` schema is defined in [`message.py`](https://github.com/portals-ai/portals/blob/main/src/backend/base/portals/schema/message.py).
