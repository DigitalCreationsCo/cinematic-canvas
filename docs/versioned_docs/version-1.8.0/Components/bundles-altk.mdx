...
:::tip
The ALTK contains features called _components_. These are different from Portals components. All components within ALTK are available through Portals's **ALTK Agent** component.
:::
...
For an example of the ALTK component in Portals, see the video tutorial [ALTK in Portals: Reliably handle JSON responses in your AI agent](https://www.youtube.com/watch?v=YNwPBK_KxXY).
