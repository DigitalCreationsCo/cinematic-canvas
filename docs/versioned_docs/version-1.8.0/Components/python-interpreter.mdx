...
The **Python Interpreter** component can only import packages that are already installed in your Portals environment.
...
3. To pass a URL input to the **Python Interpreter** component, make the following changes to the code:
   ...
   The following example demonstrates these modifications.
    ...
    from px.schema.message import Message  # Needed to extract text from Message objects
