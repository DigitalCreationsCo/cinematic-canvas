...
This component provides an [Exa Search](https://exa.ai/) toolkit for search and content retrieval by a Portals [**Agent** component](/agents) or [MCP client](/mcp-client).
