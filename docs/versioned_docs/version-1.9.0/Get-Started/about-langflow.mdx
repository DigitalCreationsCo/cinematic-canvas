...
<Cards cols={3}>
  ...
  <Card icon={<Icon name="Cloud" size={20} />} title="Deploy" href="/deployment-overview">
    Deploy Portals to production environments.
  </Card>
</Cards>
...
<Cards cols={2}>
  <Card icon={<Icon name="Zap" size={20} />} title="Trigger flows with the API" href="/concepts-publish">
    Use the Portals API to run flows from your application code.
  </Card>
  <Card icon={<Icon name="Container" size={20} />} title="Containerize your app" href="/develop-application">
    Build and deploy Portals as a containerized application.
  </Card>
</Cards>
...
<Cards cols={2}>
  <Card icon={<Icon name="Bot" size={20} />} title="Portals Agents" href="/agents">
    Build and configure AI agents with Portals.
  </Card>
  ...
  <Card icon={<Icon name="Plug" size={20} />} title="MCP server" href="/mcp-server">
    Expose Portals as an MCP server.
  </Card>
  <Card icon={<Icon name="Cable" size={20} />} title="MCP client" href="/mcp-client">
    Connect Portals to external MCP servers.
  </Card>
</Cards>
