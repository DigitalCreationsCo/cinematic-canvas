...
Follow these best practices when submitting a template to Portals.

For template formatting examples, see [`/starter_projects`](https://github.com/portals-ai/portals/tree/main/src/backend/base/portals/initial_setup/starter_projects) in the Portals repository.

## Create a PR to submit your template

Follow these steps to submit your template:

1. Fork the [Portals repository](https://github.com/portals-ai/portals) on GitHub.
...
4. Create a Pull Request (PR) from your fork to the main Portals repository.
5. Include a screenshot of your template in the PR.

The Portals team will review your PR, offer feedback, and, if approved, merge the template.
...
Don't use custom components that aren't part of the Portals codebase.
...
For more information, see the Portals repository's [template categories](https://github.com/portals-ai/portals/blob/main/src/frontend/src/modals/templatesModal/index.tsx#L27-L57).