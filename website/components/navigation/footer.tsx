  ...
  return (
    <footer className="w-full relative z-10 glass-brick border-t border-border/20 flex flex-col text-sm text-foreground">
      ...
      <div className="w-full py-12 px-4 lg:px-8">
        <div className="max-w-4xl mx-auto flex flex-col-reverse md:flex-row justify-between md:items-end text-xs text-muted-foreground">
          <p className="mx-auto md:mx-0">&copy; { new Date().getFullYear() } Cinematic Canvas. All rights reserved.</p>
