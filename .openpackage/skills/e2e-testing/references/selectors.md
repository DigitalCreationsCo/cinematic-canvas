# Portals E2E Selector Catalog

This is the canonical reference for `data-testid` selectors used in Portals E2E tests. When adding new interactive elements, follow these naming conventions and add the element to this catalog.
