...
function transformLighting(oldLighting: any): any {
    ...
    return {
        ...
        motivatedSources: {
            "Primary Light": oldLighting.motivatedSources,
            "Fill Light": undefined,
            "Practical Lights": "None", // Default as it is required? Check Schema.
            "Accent Light": undefined,
            "Light Beams": "None" // Default
        },
        direction: {
            "Key Light Position": oldLighting.direction,
            "Shadow Direction": undefined,
            "Contrast Ratio": undefined
        },
        atmosphere: {
            "Haze": "None"
        }
