...
This document provides patterns for reducing cognitive complexity in Portals React components.

## Understanding Complexity

### SonarJS Cognitive Complexity

Portals does not have automated complexity analysis tools. Assess complexity manually using SonarJS cognitive complexity rules:
