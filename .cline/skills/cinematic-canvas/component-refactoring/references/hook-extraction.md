...
This document provides detailed guidance on extracting custom hooks from complex components in Portals.
...
- Match existing Portals patterns: `useFlowsManagerStore`, `useFlowStore`
...
## Common Hook Patterns in Portals
...
Portals has keyboard shortcut support. Extract shortcut handling to hooks.
