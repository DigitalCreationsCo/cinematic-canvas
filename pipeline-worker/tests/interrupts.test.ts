...
import { checkAndPublishInterruptFromSnapshot, mergeParamsIntoState } from '../interrupts';
...
describe('Interrupt Handling System', () => {
    ...
    describe('mergeParamsIntoState', () => {
        ...
        it('should merge creativePrompt', () => {
            const currentState: any = {
                creativePrompt: 'old'
            };
            const params = {
            ...
            expect(updates.creativePrompt).toEqual('new');
        });
    });
});
