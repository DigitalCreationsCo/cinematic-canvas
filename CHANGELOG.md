...
- **CREATE_SCENES_WITH_ENTITIES Job Handler**: Finalized hybrid search using type-safe Drizzle Query Builder for vector and FTS operations, with strict ordering on entity retrieval and parallel image/attribute generation. (`eee1b3f`, `9ebf19a`)
