      ...
      <DialogContent hideCloseButton onPointerDownOutside={(e) => e.preventDefault()} onEscapeKeyDown={(e) => e.preventDefault()} className="sm:max-w-[700px] p-8 border-none bg-background/95 backdrop-blur shadow-2xl">
        <DialogHeader className="mb-8 items-center text-center">
          ...
          <DialogDescription className="text-base">
            Choose how you'd like to begin your next project.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <div className="text-center">
              ...
              <span className="text-xs text-muted-foreground mt-1">Open existing world</span>
            </div>
          </Button>
          ...
          >
            ...
            <div className="text-center">
              ...
              <span className="text-xs text-muted-foreground mt-1">Quick start an old project</span>
            </div>
          </Button>
        </div>
      </DialogContent>
