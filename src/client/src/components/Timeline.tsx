...
const Timeline = memo(function Timeline({ scenes, selectedSceneIndex, totalDuration, isPlaying, onSceneSelect, isLoading, currentTime }: TimelineProps) {
            ...
            return (
              <Tooltip key={ scene.id }>
                <TooltipTrigger asChild>
                  <button
                    className={ cn(
                      "absolute top-1 bottom-1 rounded-md transition-all cursor-pointer overflow-hidden",
