...
export const ProjectSelectionModal: React.FC<ProjectSelectionModalProps> = ({
  ...
  } = useProjects(activeWorldId ?? undefined);
  const projects = projectsData?.projects || [];

  const [localSelectedProject, setLocalSelectedProject] = useState<string | undefined>(
    undefined,
  );
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          >
                    ...
                    {isLoadingProjects ? (
                      ...
                      projects.map((project) => (
                        <SelectItem key={project.id} value={project.id}>
                          ...
                          <span className="ml-2  text-muted-foreground font-mono opacity-50">
            ...
            <TabsContent value="create" className="flex-1 p-4 mt-0 space-y-4">
              ...
              {error && (
                <div className=" text-destructive bg-destructive/10 p-2   ">{error}</div>
              )}
