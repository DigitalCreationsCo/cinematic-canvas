...
export function RbacBanner({ isLocked: isWorldEntity, entityType }: RbacBannerProps) {
  ...
  return (
    <div className="p-3 bg-muted/50">
      <div
        ...
        className="flex flex-col flex-1 gap-1 items-start gap-3"
      >
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  variant="outline"
                  size="sm"
                  className="mt-3 w-full border-indigo-600 text-indigo-400 hover:bg-indigo-950/50"
                >
