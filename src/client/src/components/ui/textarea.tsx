...
export const textareaBaseClasses =
  "min-h-[80px] w-full px-3 py-2 border bg-input placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50 active:ring-none active:outline-none focus:ring-none focus:outline-none focus:border-elevate-2";
