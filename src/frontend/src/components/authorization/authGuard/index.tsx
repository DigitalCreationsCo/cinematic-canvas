...
import {
  IS_AUTO_LOGIN,
  PORTALS_ACCESS_TOKEN_EXPIRE_SECONDS,
  PORTALS_ACCESS_TOKEN_EXPIRE_SECONDS_ENV,
...
export const ProtectedRoute = ({ children }) => {
  ...
  useEffect(() => {
    const envRefreshTime = PORTALS_ACCESS_TOKEN_EXPIRE_SECONDS_ENV;
    const automaticRefreshTime = PORTALS_ACCESS_TOKEN_EXPIRE_SECONDS;
