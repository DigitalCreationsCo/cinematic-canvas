...
jest.mock("@/constants/constants", () => ({
  ...
  DOCS_URL: "https://docs.portals.org",
  DESKTOP_URL: "https://desktop.portals.org",
}));

jest.mock("@/customization/feature-flags", () => ({
  ENABLE_DATASTAX_PORTALS: false,
}));
...
describe("HelpDropdown", () => {
  ...
  it("opens docs in new tab and navigates to shortcuts", () => {
    ...
    fireEvent.click(
      screen.getByTestId("canvas_controls_dropdown_get_portals_desktop"),
    );
    expect(window.open).toHaveBeenCalledWith(
      "https://desktop.portals.org",
      "_blank",
    );
  });
});
