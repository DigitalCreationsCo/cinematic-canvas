//import PortalsLogoColor from "@/assets/PortalsLogocolor.svg?react";
...
import { PortalsButtonRedirectTarget } from "@/customization/utils/urls";
...
export default function IOModal({
  ...
  const PortalsButtonClick = () => {
    track("PortalsButtonClick");
    customOpenNewTab(PortalsButtonRedirectTarget());
  };
              ...
              >
                ...
                {sidebarOpen && showPublishOptions && (
                  <div className="absolute bottom-2 left-0 flex w-full flex-col gap-8 border-t border-border px-2 py-4 transition-all">
                    ...
                    <Button
                      onClick={PortalsButtonClick}
                      variant="primary"
                      className="w-full !rounded-xl shadow-lg"
                    >
                      <PortalsLogoColor />
                      <div className="text-sm">
                        {t("modal.io.builtWithPortals")}
                      </div>
                    </Button>
                  </div>
                )}
            ...
            {!sidebarOpen && showPublishOptions && (
              <div className="absolute bottom-6 left-4 hidden transition-all md:block">
                <ShadTooltip
                  styleClasses="z-50"
                  side="right"
                  content={t("modal.io.builtWithPortalsTooltip")}
                >
                  <Button
                    variant="primary"
                    ...
                    onClick={PortalsButtonClick}
                  >
                    <PortalsLogoColor className="h-[18px] w-[18px] scale-150" />
                  </Button>
                </ShadTooltip>
              </div>
            )}
