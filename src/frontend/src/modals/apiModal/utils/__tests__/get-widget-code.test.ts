...
describe("getWidgetCode", () => {
  ...
  describe("Basic widget code generation", () => {
    it("should generate widget code with API key when isAuth is false", () => {
      ...
      expect(code).toContain(
        "https://cdn.jsdelivr.net/gh/logspace-ai/portals-embedded-chat",
      );
      expect(code).toContain("@v1.0.7");
      expect(code).toContain("</script>");

      // Check for portals-chat component
      expect(code).toContain("<portals-chat");
    ...
    it("should generate widget code without API key when isAuth is true", () => {
      ...
      expect(code).toContain("<script");
      expect(code).toContain(
        "https://cdn.jsdelivr.net/gh/logspace-ai/portals-embedded-chat@v1.0.7",
      );
    ...
    it("should use formatted CDN URL when copy is true", () => {
      ...
      expect(code).toContain(
        "https://cdn.jsdelivr.net/gh/logspace-ai/portals-embedded-chat@v1.0.7/dist/build/static/js/bundle.min.js",
      );
  ...
  describe("Code structure", () => {
    it("should have proper HTML structure with script and portals-chat tags", () => {
      const code = getWidgetCode(baseOptions);
      ...
      // Check for opening and closing portals-chat tags
      expect(code).toContain("<portals-chat");
      expect(code).toContain("</portals-chat>");
    });

    it("should have all required attributes in portals-chat component", () => {
      const code = getWidgetCode(baseOptions);
