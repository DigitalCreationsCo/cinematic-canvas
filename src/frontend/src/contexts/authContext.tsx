...
export function AuthProvider({ children }): React.ReactElement {
  ...
  function login(
    ...
    cookieManager.set(PORTALS_ACCESS_TOKEN, newAccessToken);
    cookieManager.set(PORTALS_AUTO_LOGIN_OPTION, autoLogin);
    setLocalStorage(PORTALS_ACCESS_TOKEN, newAccessToken);

    if (refreshToken) {
      cookieManager.set(PORTALS_REFRESH_TOKEN, refreshToken);
    }
