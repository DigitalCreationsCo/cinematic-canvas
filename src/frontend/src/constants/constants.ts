...
export const CODE_PROMPT_DIALOG_SUBTITLE =
  "Edit your Python code snippet. Refer to the Portals documentation for more information on how to write your own component.";
...
export const DESCRIPTIONS: string[] = [
  ...
  "Portals: Create, Chain, Communicate.",
...
export const API_PAGE_PARAGRAPH =
  "Your secret Portals API keys are listed below. Do not share your API key with others, or expose it in the browser or other client-side code.";
...
export const PORTALS_SUPPORTED_TYPES = new Set([
  "str",
  "bool",
  "float",
  "code",
...
export const PORTALS_CHAT_TITLE = "Portals Chat";
...
export const STORE_TITLE = "Portals Store";
export const NO_API_KEY = "You don't have an API key.";
export const INSERT_API_KEY = "Insert your Portals API key.";
...
export const PORTALS_ACCESS_TOKEN = "access_token_lf";
export const PORTALS_API_TOKEN = "apikey_tkn_lflw";
export const PORTALS_AUTO_LOGIN_OPTION = "auto_login_lf";
export const PORTALS_REFRESH_TOKEN = "refresh_token_lf";

export const PORTALS_ACCESS_TOKEN_EXPIRE_SECONDS = 60 * 60 - 60 * 60 * 0.1;
export const PORTALS_ACCESS_TOKEN_EXPIRE_SECONDS_ENV =
...
export const IS_AUTO_LOGIN =
  !getEnvVar("PORTALS_AUTO_LOGIN") ||
  String(getEnvVar("PORTALS_AUTO_LOGIN"))?.toLowerCase() !== "false";
...
export const GITHUB_URL = "https://github.com/portals-ai/portals";
export const TWITTER_URL = "https://x.com/portals_ai";
export const DOCS_URL = "https://docs.portals.org";
export const DATASTAX_DOCS_URL =
  "https://docs.datastax.com/en/portals/index.html";
export const DESKTOP_URL = "https://www.portals.org/desktop";
export const BUG_REPORT_URL = "https://github.com/portals-ai/portals/issues";
