...
test(
  ...
  async ({ page }) => {
    ...
    const codeInputCode = `
# from portals.field_typing import Data
from portals.custom import Component
from portals.io import CodeInput, Output
...
class CustomComponent(Component):
    ...
    documentation: str = "https://docs.portals.org/components-custom-components"
...
from portals.field_typing import Code
from portals.interface.custom.custom_component import CustomComponent
from portals.interface.custom.utils import get_function
