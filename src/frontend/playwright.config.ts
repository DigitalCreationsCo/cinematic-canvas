...
export default defineConfig({
  ...
  webServer: [
    {
      command:
        "uv run uvicorn --factory portals.main:create_app --host localhost --port 7860 --loop asyncio --log-level error --no-access-log",
      port: 7860,
      env: {
        PORTALS_DATABASE_URL: "sqlite:///./temp",
        PORTALS_AUTO_LOGIN: "true",
        PORTALS_DEACTIVATE_TRACING: "true",
