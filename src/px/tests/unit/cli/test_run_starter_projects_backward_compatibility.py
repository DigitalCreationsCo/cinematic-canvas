...
Tests that all starter project JSON files from tag 1.6.0 can be loaded by px run command
without import errors for portals modules. We expect execution errors
...
class TestRunStarterProjectsBackwardCompatibility:
    ...
    def test_run_1_6_0_starter_project_no_import_errors(self, template_file):
        ...
        but there should be NO errors about importing portals or px modules.
        ...
        known_failing_projects = {
            "News Aggregator.json": "Contains SaveToFile component with portals.api import bug "
    ...
    @pytest.mark.xfail(
        reason="1.6.0 basic templates have portals import issues - components expect portals package to be available"
    )
    def test_run_basic_1_6_0_starter_projects_detailed(self):
        ...
        for template_name in basic_templates:
            ...
            if "No module named 'portals'" in all_output:
                pytest.fail(f"Portals import error in 1.6.0 template {template_name}")
    ...
    def test_run_1_6_0_starter_project_inline_json(self, template_file):
        ...
        all_output = result.output
        if "No module named 'portals'" in all_output:
            pytest.fail("Portals import error in 1.6.0 inline JSON test")
