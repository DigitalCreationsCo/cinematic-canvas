...
class TestReadFileBytes:
    ...
    async def test_read_local_file(self, tmp_path):
        ...
        with patch("px.base.data.storage_utils.get_settings_service", return_value=mock_settings):
    ...
    async def test_read_local_file_not_found(self):
        ...
        with patch("px.base.data.storage_utils.get_settings_service", return_value=mock_settings):  # noqa: SIM117
    ...
    async def test_read_s3_file(self):
        ...
        with (
            patch("px.base.data.storage_utils.get_settings_service", return_value=mock_settings),
            patch("px.base.data.storage_utils.get_storage_service", return_value=mock_storage),
        ):
