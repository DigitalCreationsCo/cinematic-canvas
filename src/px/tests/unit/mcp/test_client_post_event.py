"""Tests for PortalsClient.post_event -- best-effort event emission."""
...
@pytest.fixture
def client():
    return PortalsClient(server_url="http://localhost:7860", api_key="test-key")  # pragma: allowlist secret
