...
class TestImportAttr:
    ...
    def test_import_module_with_none_module_name(self):
        ...
        result = import_mod("models_and_agents", None, "px.components")
    ...
    def test_import_module_with_module_name(self):
        ...
        # This should import the module directly using the attr_name
        result = import_mod("models_and_agents", "__module__", "px.components")
    ...
    def test_import_modibute_from_module(self):
        ...
        result = import_mod("AnthropicModelComponent", "anthropic", "px.components.anthropic")
    ...
    def test_import_nonexistent_module(self):
        ...
        with pytest.raises(ImportError, match="not found"):
            import_mod("SomeComponent", "nonexistent_module", "px.components.openai")
    ...
    def test_module_not_found_error_handling(self):
        ...
        with patch("px.components._importing.import_module") as mock_import_module:
    ...
    def test_relative_import_behavior(self):
        ...
        result = import_mod("helpers", "__module__", "px.components")
        assert result is not None
    ...
    def test_package_resolution(self):
        ...
        result = import_mod("CalculatorComponent", "calculator_core", "px.components.helpers")
        assert result is not None
    ...
    def test_import_mod_with_special_module_name(self):
        ...
        result = import_mod("data", "__module__", "px.components")
        assert result is not None

        # Test with None - should also import the attr_name as a module
        result2 = import_mod("data", None, "px.components")
        assert result2 is not None

    def test_error_message_formatting(self):
        """Test that error messages are properly formatted."""
        with pytest.raises(ImportError) as exc_info:
            import_mod("NonExistent", "nonexistent", "px.components")

        error_msg = str(exc_info.value)
        assert "px.components" in error_msg
        assert "nonexistent" in error_msg

    def test_return_value_types(self):
        """Test that import_mod returns appropriate types."""
        # Test module import
        module_result = import_mod("openai", "__module__", "px.components")
    ...
    def test_caching_independence(self):
        ...
        result1 = import_mod("models_and_agents", "__module__", "px.components")
        result2 = import_mod("models_and_agents", "__module__", "px.components")
