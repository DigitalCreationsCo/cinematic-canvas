...
class TestWatsonxAIComponent:
    ...
    @patch("px.components.ibm.watsonx.WatsonxAIComponent.fetch_models")
    ...
    @patch("px.components.ibm.watsonx.ChatWatsonx")
    ...
    @patch("px.components.ibm.watsonx.SecretStr", MockSecretStr)
    @patch("px.components.ibm.watsonx.ChatWatsonx")
    ...
    @patch("px.components.ibm.watsonx.WatsonxAIComponent.fetch_models")
    @patch("px.components.ibm.watsonx.logger")
