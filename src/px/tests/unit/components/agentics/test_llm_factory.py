...
import pytest
from px.components.agentics.constants import (
    DEFAULT_OLLAMA_URL,
    LLM_MODEL_PREFIXES,
    PROVIDER_ANTHROPIC,
    PROVIDER_GOOGLE,
...
from px.components.agentics.helpers.llm_factory import create_llm
...
class TestCreateLlm:
    ...
    def test_should_create_openai_llm_with_correct_prefix(
        self, mock_crewai_llm: MagicMock
    ):
        # Act
    ...
    def test_should_create_anthropic_llm_with_correct_prefix(
        self, mock_crewai_llm: MagicMock
    ):
        # Act
    ...
    def test_should_create_google_llm_with_correct_prefix(
        self, mock_crewai_llm: MagicMock
    ):
        # Act
    ...
    def test_should_use_default_ollama_url_when_none_provided(
        self, mock_crewai_llm: MagicMock
    ):
        # Act
    ...
    def test_should_raise_value_error_for_unsupported_provider(
        self, mock_crewai_llm: MagicMock
    ):
        # Act & Assert
