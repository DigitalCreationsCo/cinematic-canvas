...
import pytest
from px.base.models.model_metadata import MODEL_PROVIDER_METADATA
from px.base.models.unified_models import get_language_model_options, get_llm
from px.base.models.unified_models.provider_queries import get_model_providers
...
def _patch_all_providers_enabled():
    ...
    return patch(
        "px.base.models.unified_models.model_catalog._fetch_enabled_providers_for_user",
...
class TestGetLlmMaxTokensKwarg:
    ...
    def test_max_tokens_kwarg_name_per_provider(self, provider: str, expected_kwarg: str):
        ...
        with (
            patch(
                "px.base.models.unified_models.get_model_class",
                return_value=mock_cls,
            ),
            patch(
                "px.base.models.unified_models.get_api_key_for_provider",
