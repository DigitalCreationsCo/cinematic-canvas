...
import pytest
from px.services.mcp_composer.service import MCPComposerPortError, MCPComposerService
...
class TestOAuthCallbackConfigForwarding:
    ...
    async def test_callback_url_backwards_compat(self, mcp_service):
        ...
        with (
            patch("px.services.mcp_composer.service.get_settings_service", return_value=mock_settings),
