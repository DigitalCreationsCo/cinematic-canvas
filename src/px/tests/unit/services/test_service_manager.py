...
from px.services.manager import NoFactoryRegisteredError, ServiceManager
...
class TestPluginDiscovery:
    ...
    def test_discover_storage_from_config_file(self, service_manager, temp_config_dir):
        """Test discovering LocalStorageService from px.toml."""
        config_file = temp_config_dir / "px.toml"
...
[services]
storage_service = "px.services.storage.local:LocalStorageService"
telemetry_service = "px.services.telemetry.service:TelemetryService"
tracing_service = "px.services.tracing.service:TracingService"
variable_service = "px.services.variable.service:VariableService"
"""
        )
...
"""
    ...
    def test_px_toml_takes_precedence_over_pyproject(self, service_manager, temp_config_dir):
        """Test that px.toml is preferred over pyproject.toml."""
        # Create both files
        (temp_config_dir / "px.toml").write_text(
            """
[services]
storage_service = "px.services.storage.local:LocalStorageService"
"""
...
"""
        ...
        # Should have loaded from px.toml (storage_service)
        assert ServiceType.STORAGE_SERVICE in service_manager.service_classes
