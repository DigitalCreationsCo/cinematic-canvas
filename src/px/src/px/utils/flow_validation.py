...
from px.utils.component_aliases import get_component_type_aliases
...
def get_component_hash_lookups_for_validation() -> dict[str, set[str]] | None:
    ...
    if (
        ...
        type_to_hash, all_hashes = collect_component_hash_lookups(
...
def validate_flow_for_current_settings(target: Mapping[str, Any] | Any | None) -> None:
    ...
    if (
        ...
        and normalized_flow_data is None
    ):
        msg = (
