...
# This allows imports like: import px.components.knowledge_bases.retrieval
_redirected_submodules = {
    "px.components.knowledge_bases.retrieval": "px.components.files_and_knowledge.retrieval",
}
...
def __getattr__(attr_name: str) -> Any:
    ...
    package = "px.components.files_and_knowledge"
    try:
