...
from px.inputs.inputs import BoolInput, DropdownInput, IntInput, SecretStrInput
        ...
        try:
            ...
            with self.youtube_client() as youtube:
                ...
                if self.category != "All":
                    request_params["videoCategoryId"] = self.VIDEO_CATEGORIES[
                        self.category
                    ]
                        ...
                        video_data.update(
                            {
                                ...
                                "projection": content_details.get(
