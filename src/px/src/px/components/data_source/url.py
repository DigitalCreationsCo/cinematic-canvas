...
from px.helpers.data import safe_convert
from px.io import (
    BoolInput,
    DropdownInput,
    IntInput,
...
from px.utils.request_utils import get_user_agent
from px.utils.ssrf_protection import SSRFProtectionError, validate_url_for_ssrf
...
USER_AGENT = None
# Check if portals is installed using importlib.util.find_spec(name))
if importlib.util.find_spec("portals"):
    portals_installed = True
...
class URLComponent(Component):
    ...
    documentation: str = "https://docs.portals.org/url"
    ...
    outputs = [
        Output(
            display_name="Extracted Pages", name="page_results", method="fetch_content"
        ),
        Output(
    ...
    def ensure_url(self, url: str) -> str:
        ...
        # when PORTALS_SSRF_PROTECTION_ENABLED=true
        try:
