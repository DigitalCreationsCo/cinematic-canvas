...
from px.inputs.inputs import DropdownInput, SecretStrInput, StrInput
...
class NotionSearch(LCToolComponent):
    ...
    documentation: str = "https://docs.portals.org/bundles-notion"
    ...
    def run_model(self) -> list[Data]:
        ...
        for result in results:
            ...
            if result["object"] == "page":
                ...
                if (
                    "title" in result
                    and isinstance(result["title"], list)
                    and len(result["title"]) > 0
                ):
