...
from collections.abc import (
    Callable,  # noqa: TC003 - required at runtime for dynamic exec()
)
...
class LambdaFilterComponent(Component):
    ...
    documentation: str = "https://docs.portals.org/smart-transform"
    ...
    def _is_message_input(self) -> bool:
        ...
        return (
            ...
            and len(self.data) > 0
            and isinstance(self.data[0], Message)
        )
    ...
    def _build_text_prompt(self, text: str) -> str:
        ...
        return TEXT_TRANSFORM_PROMPT.format(
            text_preview=text_preview, instruction=self.filter_instruction
        )
