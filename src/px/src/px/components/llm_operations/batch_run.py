...
class BatchRunComponent(Component):
    ...
    documentation: str = "https://docs.portals.org/batch-run"
    icon = "List"
        ...
        try:
            ...
            for idx, (original_row, response) in enumerate(
                ...
                self._token_usage = accumulate_usage(
                    self._token_usage, extract_usage_from_message(response_msg)
                )
                response_text = (
                ...
                row = self._create_base_row(
                    cast("dict[str, Any]", original_row),
            ...
            error_row = self._create_base_row(
                dict.fromkeys(df.columns, ""), model_response="", batch_index=-1
            )
