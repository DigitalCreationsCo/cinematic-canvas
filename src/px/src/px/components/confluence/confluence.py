...
from px.io import BoolInput, DropdownInput, IntInput, Output, SecretStrInput, StrInput
...
class ConfluenceComponent(Component):
    ...
    def load_documents(self) -> list[Data]:
        ...
        data = [
            Data.from_document(doc) for doc in documents
        ]  # Using the from_document method of Data
        self.status = data
        return data
