...
class NvidiaIngestComponent(BaseFileComponent):
    ...
    try:
        ...
        msg = (
            ...
            "Install with `uv pip install 'portals[nv-ingest]'` "
    ...
    inputs = [
        *BaseFileComponent.get_base_inputs(),
        ...
        BoolInput(
            ...
            info=(
                "Process pdf in high-resolution mode for better quality extraction from scanned pdf."
            ),
            advanced=True,
            value=False,
        ),
    ...
    def process_files(
        ...
        try:
            ...
            msg = (
                ...
                "Please install them using your package manager. (e.g. uv pip install portals[nv-ingest])"
            )
