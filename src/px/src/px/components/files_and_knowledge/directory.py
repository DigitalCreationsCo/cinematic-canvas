from px.base.data.utils import TEXT_FILE_TYPES, parallel_load_data, parse_text_file_to_data, retrieve_file_paths
from px.custom.custom_component.component import Component
from px.io import BoolInput, IntInput, MessageTextInput, MultiselectInput
...
class DirectoryComponent(Component):
    ...
    documentation: str = "https://docs.portals.org/directory"
    icon = "folder"
    name = "Directory"
    legacy = True
