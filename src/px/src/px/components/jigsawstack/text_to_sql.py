...
from px.io import MessageTextInput, Output, QueryInput, SecretStrInput, StrInput
...
class JigsawStackTextToSQLComponent(Component):
    ...
    def generate_sql(self) -> Data:
        try:
            ...
            jigsawstack_import_error = "JigsawStack package not found. Please install it using: pip install jigsawstack>=0.2.7"
