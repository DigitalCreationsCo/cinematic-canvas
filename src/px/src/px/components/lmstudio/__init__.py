...
if TYPE_CHECKING:
    from px.components.lmstudio.lmstudioembeddings import LMStudioEmbeddingsComponent
    from px.components.lmstudio.lmstudiomodel import LMStudioModelComponent
