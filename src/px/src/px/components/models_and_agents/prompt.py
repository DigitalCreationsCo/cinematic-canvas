...
from px.base.prompts.api_utils import process_prompt_template
from px.custom.custom_component.component import Component
from px.inputs.input_mixin import FieldTypes
from px.inputs.inputs import DefaultPromptField
from px.io import BoolInput, MessageTextInput, Output, PromptInput
from px.log.logger import logger
from px.schema.dotdict import dotdict
from px.schema.message import Message
from px.template.utils import update_template_values
from px.utils.mustache_security import validate_mustache_template
...
class PromptComponent(Component):
    ...
    async def build_prompt(self) -> Message:
        ...
        prompt = await Message.from_template_and_variables(
            template_format=template_format, **self._attributes
        )
