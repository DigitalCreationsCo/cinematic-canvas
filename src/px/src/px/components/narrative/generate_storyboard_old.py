...
class GenerateStoryboardComponent(StructuredOutputComponent):
    ...
    description = "Runs a language model given a specified provider to generate a structured storyboard."
    icon = "sparkles"
    documentation: str = "https://docs.portals.org/components-models"
    category = "models"

    def build_system_prompt(self) -> str:
        return build_storyboard_vision_prompt(self.input_value, self.title or "")
    ...
    inputs = [
        ...
        MultilineInput(
            ...
            info="The prompt to generate the storyboard.",
            tool_mode=True,
            required=True,
        ),
        MessageTextInput(
