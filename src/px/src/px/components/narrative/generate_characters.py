...
from px.inputs.inputs import BoolInput, DropdownInput, HandleInput, MessageTextInput
from px.schema.data import Data
from px.schema.dataframe import DataFrame
from px.schema.message import Message
from px.schema.properties import Source
...
class GenerateCharacters(ToolCallingAgentComponent):
    display_name = "Generate Characters"
    description = "Generate characters and character agents."
    # documentation: str = "https://docs.portals.org/chat-input-and-output"
    icon = "MessagesSquare"
