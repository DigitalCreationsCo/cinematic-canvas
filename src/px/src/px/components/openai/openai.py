...
from px.base.models.openai_constants import OPENAI_EMBEDDING_MODEL_NAMES
...
class OpenAIEmbeddingsComponent(LCEmbeddingsModel):
    ...
    inputs = [
        ...
        IntInput(
            name="chunk_size", display_name="Chunk Size", advanced=True, value=1000
        ),
        ...
        MessageTextInput(
            name="openai_proxy", display_name="OpenAI Proxy", advanced=True
        ),
        FloatInput(
