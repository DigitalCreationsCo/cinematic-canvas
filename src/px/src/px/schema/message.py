...
from px.base.prompts.utils import dict_values_to_string
from px.log.logger import logger
from px.schema.content_block import ContentBlock
from px.schema.content_types import ErrorContent
from px.schema.data import Data
from px.schema.image import Image, get_file_paths, is_image_file
from px.schema.properties import Properties, Source
from px.schema.validators import timestamp_to_str, timestamp_to_str_validator
from px.utils.constants import MESSAGE_SENDER_AI, MESSAGE_SENDER_NAME_AI, MESSAGE_SENDER_NAME_USER, MESSAGE_SENDER_USER
from px.utils.image import create_image_content_dict
from px.utils.mustache_security import safe_mustache_render
...
class Message(Data):
    ...
    def get_file_content_dicts(self, model_name: str | None = None):
        ...
        for file in files:
            ...
            try:
                ...
                from px.base.data.utils import parse_text_file_to_data
    ...
    def to_dataframe(self) -> DataFrame:
        from px.schema.dataframe import DataFrame  # Local import to avoid circular import
