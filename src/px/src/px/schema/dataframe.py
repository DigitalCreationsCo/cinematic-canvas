"""Table class for px package - pandas DataFrame subclass for Portals data structures.

This module provides the Table class (formerly DataFrame) as the base type for tabular data in Portals.
...
class Table(pandas_DataFrame):
    ...
    This is the base type for Portals tabular data structures, replacing the legacy DataFrame class.
    DataFrame is maintained as an alias for backwards compatibility.

    This class extends pandas.DataFrame to provide seamless integration between
    Portals's JSON objects and pandas' powerful data manipulation capabilities.
