...
from px.custom.custom_component.base_component import BaseComponent
from px.helpers import (
...
from px.services.deps import get_storage_service, get_variable_service, session_scope
from px.services.storage.service import StorageService
from px.template.utils import update_frontend_node_with_template_values
from px.type_extraction import post_process_type
...
if TYPE_CHECKING:
    ...
    from px.schema.schema import OutputValue
    from px.services.storage.service import StorageService
    from px.services.tracing.service import TracingService


class CustomComponent(BaseComponent):
    """Represents a custom component in Portals.
    ...
    def tracing_service(self):
        ...
        if self._tracing_service is None:
            from px.services.deps import get_tracing_service
