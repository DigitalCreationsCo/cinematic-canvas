...
from px.template.frontend_node.custom_components import ComponentFrontendNode, CustomComponentFrontendNode
                ...
                for category_dir in base_path.iterdir():
                    if category_dir.is_dir():
                        ...
                        if component_file.exists():
                            # Try to import the module
                            module_name = f"px.components.{category_dir.name}.{component_name}"
                            try:
                                import importlib.util
