...
pluggable services architecture. PX provides a minimal no-op implementation;
full-featured implementations (JWT, OIDC, SAML) live in Portals or plugins.
...
class BaseAuthService(Service, abc.ABC):
    ...
    async def get_current_user_from_access_token(
        self, token: str | Coroutine[Any, Any, str] | None, db: Any
    ) -> Any:
