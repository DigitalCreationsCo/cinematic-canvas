...
from px.services.adapters.payload import AdapterPayload, PayloadSlot, ProviderPayloadSchemas
...
class DeploymentPayloadFields(ProviderPayloadSchemas):
    ...
    - Portals mappers populate ``DeploymentApiPayloads`` (API-side contracts)
    """
