...
from px.services.telemetry.base import BaseTelemetryService
from px.services.telemetry.schema import (
    ExceptionPayload,
    MCPToolPayload,
    ShutdownPayload,
    VersionPayload,
...
_DEFAULT_BASE_URL = "https://portals.gateway.scarf.sh"
    ...
    def __init__(
        ...
        *,
        ...
        self.base_url = base_url or os.environ.get(
            "PORTALS_TELEMETRY_BASE_URL", _DEFAULT_BASE_URL
        )

        if do_not_track is None:
            do_not_track = os.environ.get("DO_NOT_TRACK", "false").lower() in {
                "1",
                "true",
            }
        ...
        self._common_fields = {
            "portals_version": self._get_version(),
            "platform": "mcp",
