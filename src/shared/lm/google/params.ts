...
import { GoogleGenerateContentParameters, CountTokensParameters } from "./provider.js";
 ...
 * with no fields".
 */
function prepareBatchInputs(
    requests: Parameters<ITextModelProvider['generateBatchContent']>[0]['requests']
): string {
