import { createMockScene } from '../../mocks/entities/mock-scene.js';
...
import { buildQualityControlPrompt, buildQualityControlVideoPrompt, buildQualityControlFramePrompt } from '#shared/prompts/quality-control.prompt.js';
