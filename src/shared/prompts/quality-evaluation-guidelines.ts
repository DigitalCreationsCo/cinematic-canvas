/**
 * @fileoverview Quality Evaluation Guidelines - Rubrics & Classification
 * 
 * Defines comprehensive evaluation criteria, severity classifications, and
 * scoring rubrics for assessing generated video and frame quality.
 * 
 * @module shared/prompts/quality-evaluation-guidelines
 * 
 * @description
 * This module provides the evaluation framework used by the Quality Control
 * Supervisor role to assess generated assets. It includes:
 * - Issue severity classification (critical, major, minor)
 * - Semantic understanding checklist for domain-specific terms
 * - Rating thresholds for each evaluation dimension
 * - Prompt correction principles for iterative refinement
 * - Generation rule suggestion guidelines
 * 
 * @usage
 * Used by: role-quality-control.ts
 * 
 * @see role-quality-control.ts - The primary consumer of these guidelines
 */
