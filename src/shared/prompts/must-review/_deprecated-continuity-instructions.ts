/**
 * @fileoverview DEPRECATED - Continuity Instructions (Legacy)
 * 
 * @deprecated This module is deprecated and no longer used in production.
 * Replaced by: role-script-supervisor.ts and continuity-manager.ts
 * 
 * @module shared/prompts/_deprecated-continuity-instructions
 * 
 * @description
 * Legacy continuity management prompts. The new architecture uses role-based
 * department heads (Script Supervisor) for continuity tracking.
 * 
