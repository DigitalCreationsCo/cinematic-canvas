/**
 * @fileoverview DEPRECATED - Storyboard Composition Instruction (Legacy)
 * 
 * @deprecated This module is deprecated and no longer used in production.
 * Replaced by: prompt-composer.ts and compositional-agent.ts
 * 
 * @module shared/prompts/_deprecated-storyboard-composition-instruction
 * 
 * @description
 * Legacy storyboard enrichment logic. The new architecture uses the
 * prompt-composer module to orchestrate multiple role-based department
 * prompts into cohesive generation instructions.
 * 
