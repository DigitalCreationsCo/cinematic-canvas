/**
 * @fileoverview Audio Analysis Instruction - Temporal Sonic Architect
 * 
 * Generates system prompts for the audio processing agent that analyzes music tracks
 * and segments them into narrative beats for cinematic video generation.
 * 
 * @module shared/prompts/audio-analysis-instruction
 * 
 * @description
 * This module provides the "Temporal Sonic Architect" persona that performs deep
 * audio analysis to create storyboards synchronized with musical structure. It:
 * - Detects BPM, frequency density, and impact moments
 * - Segments audio into logical dramatic beats (4s, 6s, or 8s increments)
 * - Maps emotional arcs, intensity, and mood to visual direction
 * - Ensures zero-gap continuity across all segments
 * 
 * @usage
 * Used by: src/shared/agents/media-processing-agent.ts
 * 
 * @example
 * const prompt = buildAudioProcessingInstruction(30, [4, 6, 8], schema);
 * // Returns prompt instructing AI to analyze 30s audio into valid segments
 * 
