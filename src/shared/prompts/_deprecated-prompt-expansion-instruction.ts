/**
 * @fileoverview DEPRECATED - Prompt Expansion Instruction (Legacy)
 * 
 * @deprecated This module is deprecated and no longer used in production.
 * Replaced by: role-director.ts and compositional-agent.ts
 * 
 * @module shared/prompts/_deprecated-prompt-expansion-instruction
 * 
 * @description
 * Legacy prompt expansion logic that transformed simple user prompts into
 * detailed cinematic blueprints. The new architecture uses the Director role
 * for creative vision establishment.
 * 
