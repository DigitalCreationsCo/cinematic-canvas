...
import { InsertProject } from "#shared/types/schema.types.ts";
import { z } from "zod";

const isIntegrationTest = process.env.RUN_INTEGRATION_TESTS === 'true';

describe.skipIf(!isIntegrationTest)("ProjectRepository Asset Persistence", () => {
    ...
    beforeAll(async () => {
        ...
        const insertProject: z.input<InsertProject> = {
          id: projectId,
          teamId: generateId(),
            metadata: {
