...
export const EntityUnion = z.union([CharacterWithAssets, LocationWithAssets, SceneWithAssets, PropWithAssets]);
export type EntityUnion = z.infer<typeof EntityUnion>;

export const EntityInsertUnion = z.union([CharacterBase, LocationBase, SceneBase, PropBase]);
