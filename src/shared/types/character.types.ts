...
export const CharacterState = z.object({
  ...
  lastExitDirection: z
    ...
    .optional()
    .describe("direction character exited frame in previous scene"),
  ...
  emotionalHistory: z
    ...
    .optional()
    .default([])
    .describe("emotional state timeline across scenes"),
  ...
  injuries: z
    ...
    .optional()
    .default([])
    .describe("injuries that persist across scenes"),

  // Appearance changes
  dirtLevel: z
    .enum(["clean", "slightly_dirty", "dirty", "very_dirty", "covered"])
    .optional()
    .default("clean")
    .describe("accumulation of dirt, mud, dust"),
  ...
  costumeCondition: z
    .object({
      tears: z
        ...
        .optional()
        .default([])
        .describe("torn areas (e.g., 'sleeve torn', 'pants ripped at knee')"),
      stains: z.array(z.string()).optional().default([]).describe("stains (e.g., 'blood on shirt', 'mud on pants')"),
      wetness: z
        .enum(["dry", "damp", "wet", "soaked"])
        .optional()
        .default("dry")
        .describe("moisture level of clothing"),
      damage: z
        .array(z.string())
        .optional()
        .default([])
        .describe("other damage (e.g., 'burned collar', 'missing button')"),
    })
    .optional()
    .describe("progressive costume degradation"),
  ...
  hairCondition: z
    ...
    .optional()
    .describe("progressive hair state changes"),
});
