...
describe('ContinuityManagerAgent', () => {
    ...
    it('should skip generation if frames exist in storage', async () => {
        ...
        expect(result[ 0 ].startFrame).toBe('gs://bucket/frames/scene_1_start.png');
        expect(result[ 0 ].endFrame).toBe('gs://bucket/frames/scene_1_end.png');
    });
    ...
    it('should generate frames if they do not exist in storage', async () => {
        ...
        expect(result[ 0 ].startFrame).toBe('gs://bucket/generated_frame.png');
        expect(result[ 0 ].endFrame).toBe('gs://bucket/generated_frame.png');
    });
});
