...
export const apiContract = {
  ...
  projects: {
    ...
    start: { method: 'POST' as const, path: '/project/start', body: z.object({ projectId: z.string(), initialPrompt: z.string().optional() }), responses: z.object({ message: z.string(), projectId: z.string(), commandId: z.string() }) },
    stop: { method: 'POST' as const, path: '/project/stop', body: z.object({ projectId: z.string() }), responses: z.object({ message: z.string(), projectId: z.string(), commandId: z.string() }) },
