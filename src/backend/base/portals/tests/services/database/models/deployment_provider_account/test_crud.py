...
_ENCRYPT_TARGET = "portals.services.database.models.deployment_provider_account.crud.auth_utils"
_CRUD_LOGGER = "portals.services.database.models.deployment_provider_account.crud.logger"
