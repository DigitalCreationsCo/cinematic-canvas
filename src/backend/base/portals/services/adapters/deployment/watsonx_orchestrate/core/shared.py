...
from px.services.adapters.deployment.exceptions import InvalidContentError, ResourceConflictError

from portals.services.adapters.deployment.watsonx_orchestrate.core.config import create_config, validate_connection
...
from portals.services.adapters.deployment.watsonx_orchestrate.payloads import WatsonxResultToolRefBinding
...
if TYPE_CHECKING:
    ...
    from px.services.adapters.deployment.schema import BaseFlowArtifact, IdLike
...
async def create_connection_with_conflict_mapping(
    *,
    ...
    from px.services.adapters.deployment.schema import DeploymentConfig
