...
from px.services.adapters.deployment.base import BaseDeploymentService
...
from px.services.adapters.payload import AdapterPayloadMissingError, AdapterPayloadValidationError

from portals.services.adapters.deployment.watsonx_orchestrate.client import get_authenticator, get_provider_clients
...
from portals.services.adapters.deployment.watsonx_orchestrate.core.create import (
...
from portals.services.adapters.deployment.watsonx_orchestrate.core.models import (
...
from portals.services.adapters.deployment.watsonx_orchestrate.core.tools import (
    ...
    extract_portals_connections_binding,
    upload_tool_artifact_bytes,
    verify_tools_by_ids,
)
from portals.services.adapters.deployment.watsonx_orchestrate.core.update import (
...
class WatsonxOrchestrateDeploymentService(BaseDeploymentService):
    ...
    async def update_snapshot(
        ...
        *,
        ...
        Portals flow name. This is intentional: the user may have set a
        ...
        * **Tool renamed in wxO console** — The new name is picked up
          ...
          Portals never stores the tool name locally.
        ...
        **Blast-radius boundary:** callers must verify that ``snapshot_id``
        is tracked by a Portals attachment record before calling this
        ...
        # been deployed with a custom name that differs from the Portals flow
