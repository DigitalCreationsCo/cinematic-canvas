...
def register_all_service_factories() -> None:
    ...
    from portals.services.cache import factory as cache_factory
    from portals.services.chat import factory as chat_factory
    from portals.services.database import factory as database_factory
    from portals.services.job_queue import factory as job_queue_factory
    from portals.services.session import factory as session_factory
    from portals.services.shared_component_cache import (
        factory as shared_component_cache_factory,
    )
    from portals.services.state import factory as state_factory
    from portals.services.storage import factory as storage_factory
    from portals.services.store import factory as store_factory
    from portals.services.task import factory as task_factory
    from portals.services.telemetry import factory as telemetry_factory
...
def register_builtin_adapters() -> None:
    ...
    try:
        import_module("portals.services.adapters.deployment.watsonx_orchestrate")
