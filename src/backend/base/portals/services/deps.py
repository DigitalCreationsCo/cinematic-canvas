...
if TYPE_CHECKING:
    ...
    from portals.services.tracing.service import TracingService
    from portals.services.variable.service import VariableService
...
from portals.services.job_queue.service import JobQueueService  # noqa: TC001
from portals.services.storage.service import StorageService  # noqa: TC001
from portals.services.telemetry.service import TelemetryService  # noqa: TC001
...
def get_service(service_type: ServiceType, default=None):
    ...
    if not service_manager.are_factories_registered():
        ...
        from portals.services.manager import ServiceManager
...
def get_telemetry_service() -> TelemetryService:
    ...
    """
    from portals.services.telemetry.factory import TelemetryServiceFactory
...
def get_tracing_service() -> TracingService:
    ...
    """
    from portals.services.tracing.factory import TracingServiceFactory
...
def get_state_service() -> StateService:
    ...
    """
    from portals.services.state.factory import StateServiceFactory
...
def get_storage_service() -> StorageService:
    ...
    """
    from portals.services.storage.factory import StorageServiceFactory
...
def get_variable_service() -> VariableService:
    ...
    """
    from portals.services.variable.factory import VariableServiceFactory
...
async def session_scope() -> AsyncGenerator[AsyncSession, None]:
    ...
    """
    from px.services.deps import session_scope as px_session_scope

    async with px_session_scope() as session:
        yield session
...
def get_shared_component_cache_service() -> CacheService:
    ...
    Returns:
        The cache service instance.
    """
    from portals.services.shared_component_cache.factory import SharedComponentCacheServiceFactory
...
def get_session_service() -> SessionService:
    ...
    """
    from portals.services.session.factory import SessionServiceFactory
...
def get_task_service() -> TaskService:
    ...
    """
    from portals.services.task.factory import TaskServiceFactory
...
def get_queue_service() -> JobQueueService:
    ...
    from portals.services.job_queue.factory import JobQueueServiceFactory
...
def get_auth_service() -> BaseAuthService:
    ...
    from portals.services.auth.factory import AuthServiceFactory
...
def get_job_service():
    ...
    """
    from portals.services.jobs.factory import JobServiceFactory

    return get_service(ServiceType.JOB_SERVICE, JobServiceFactory())


def get_flow_events_service():
    from portals.services.flow_events.factory import FlowEventsServiceFactory
