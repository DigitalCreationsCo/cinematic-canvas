...
class CollectingSpanProcessor(SpanProcessor):
    ...
    def on_start(self, span, parent_context=None):
        ...
        if span.name in ("Portals", "Language Model"):
            span.set_attribute("portals.correlation_id", self.correlation_id)
...
class ArizePhoenixTracer(BaseTracer):
    ...
    def __init__(
        ...
        try:
            ...
            self.root_span.set_attribute("portals.trace_id", str(self.trace_id))
            self.root_span.set_attribute("portals.session_id", str(self.session_id))
            self.root_span.set_attribute("portals.flow_name", self.flow_name)
            self.root_span.set_attribute("portals.flow_id", self.flow_id)
