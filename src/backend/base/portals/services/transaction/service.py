"""Transaction service implementation for portals."""
...
from portals.services.database.models.transactions.crud import log_transaction as crud_log_transaction
from portals.services.database.models.transactions.model import TransactionBase
