...
from px.services.auth.base import BaseAuthService
from sqlalchemy.exc import IntegrityError

from portals.helpers.user import get_user_by_flow_id_or_endpoint_name
from portals.services.auth.constants import AUTO_LOGIN_ERROR, AUTO_LOGIN_WARNING
...
from portals.services.database.models.user.crud import (
    get_user_by_id,
...
class AuthService(BaseAuthService):
    """Default Portals authentication service (implements PX BaseAuthService)."""
    ...
    async def _authenticate_with_token(self, token: str, db: AsyncSession) -> User:
        ...
        from portals.services.auth.utils import ACCESS_TOKEN_TYPE, get_jwt_verification_key
