...
- "generate_component": User wants you to CREATE/BUILD/GENERATE/MODIFY a custom Portals component.
...
- "question": User is ASKING A QUESTION about Portals, seeking help with Portals, or wants \
information about Portals features, components, flows, or how to use Portals.
  Examples: "How do I create a component?", "What is a component?", "Can you explain flows?", \
"How to connect two components?"
- "off_topic": The question is NOT about Portals. It is about other tools, platforms, general \
knowledge, or anything unrelated to Portals.
...
IMPORTANT rules:
- "How to create a component" = question (asking for Portals guidance)
...
- General knowledge questions NOT related to Portals = off_topic
- If unsure whether it's about Portals, classify as "question" (not off_topic)

Output format (JSON only, no markdown):
{{"translation": "<english text>", "intent": "<generate_component|question|off_topic>"}}

Examples:
Input: "como criar um componente no portals"
Output: {{"translation": "how to create a component in portals", "intent": "question"}}
