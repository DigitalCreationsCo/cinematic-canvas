"""Component search and metadata utilities for Portals."""
            ...
            for component_name, component_data in components.items():
                ...
                if query:
                    ...
                    if (
                        ...
                        and query_lower not in display_name
...
async def get_components_by_type(
    ...
    return await list_all_components(
        component_type=component_type, fields=fields, settings_service=settings_service
    )
