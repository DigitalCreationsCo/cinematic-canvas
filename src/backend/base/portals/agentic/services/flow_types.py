...
PORTALS_ASSISTANT_FLOW = "PortalsAssistant.json"
TRANSLATION_FLOW = "translation_flow.py"

OFF_TOPIC_REFUSAL_MESSAGE = (
    "I appreciate your interest, but I'm the Portals Assistant and can only help with "
    "Portals-related topics such as building components, creating flows, configuring "
    "deployments, and troubleshooting issues. Could you rephrase your question about Portals?"
)
...
Respond with a complete, valid Portals component as a Python class extending Component, \
