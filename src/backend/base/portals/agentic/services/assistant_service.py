...
from portals.agentic.helpers.input_sanitization import REFUSAL_MESSAGE, sanitize_input
...
from portals.agentic.helpers.streaming_retry import emit_execution_retry_events
from portals.agentic.helpers.validation import (
    validate_component_code,
    validate_component_runtime,
)
from portals.agentic.services.flow_executor import (
    execute_flow_file,
...
if TYPE_CHECKING:
    ...
    from portals.agentic.api.schemas import StepType
        ...
        for attempt in range(total_attempts):
            ...
            if not security_result.is_safe:
                ...
                current_input = VALIDATION_RETRY_TEMPLATE.format(
                    ...
                    "Use Portals's built-in integrations instead.",
                    code=code,
                )
                continue
