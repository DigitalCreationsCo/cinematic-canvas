...
class _ReturnChecker(ast.NodeVisitor):
    ...
    # Portals components commonly use async output methods
...
async def validate_component_runtime(code: str, user_id: str | None = None) -> str | None:
    ...
    - Wrong import paths (e.g., ``from px.base import Component`` instead of
    ...
    """
    try:
        from px.custom.custom_component.component import Component as ComponentClass
