...
REFUSAL_MESSAGE = (
    ...
    "I'm the Portals Assistant and I can help you with "
    "Portals components, flows, and technical questions. "
    "Please rephrase your question about Portals."
)
...
# legitimate Portals questions (e.g., "how do I ignore errors").
INJECTION_PATTERNS: list[tuple[re.Pattern[str], str]] = [
    ...
    (
        re.compile(
            r"forget\s+(all\s+)?(previous|prior|your)\s+instructions", re.IGNORECASE
        ),
        "Prompt injection: instruction override attempt",
    ),
    (
...
def sanitize_input(text: str) -> SanitizationResult:
    ...
    if violation:
        return SanitizationResult(
            is_safe=False, sanitized_input=text, violation=violation
        )
