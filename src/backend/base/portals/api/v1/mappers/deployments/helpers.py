...
if TYPE_CHECKING:
    ...
    from portals.api.utils import DbSession
...
# ---------------------------------------------------------------------------
# Route helpers (moved from portals.api.v1.deployments)
# ---------------------------------------------------------------------------
...
def handle_adapter_errors(*, mapper: BaseDeploymentMapper | None = None):
    ...
    ``px.services.adapters.deployment.exceptions`` module.  Non-domain
...
async def resolve_adapter_mapper_from_provider_id(
    ...
    *,
    ...
    from portals.api.v1.mappers.deployments.registry import get_deployment_mapper
