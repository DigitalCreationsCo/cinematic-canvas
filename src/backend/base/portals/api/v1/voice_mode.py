...
from portals.services.auth.utils import get_current_user_for_websocket
...
from portals.services.deps import get_variable_service, session_scope
        ...
        await websocket.send_json(
            {
                "type": "error",
                "code": "portals_auth",
                "message": "You must pass a valid Portals token or cookie.",
            }
        )
        return None, None
