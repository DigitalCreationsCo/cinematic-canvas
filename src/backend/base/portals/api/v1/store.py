...
from portals.api.utils import CurrentActiveUser, check_portals_version
from portals.services.auth import utils as auth_utils
from portals.services.deps import get_settings_service, get_store_service
from portals.services.store.exceptions import CustomError
...
async def share_component(
    ...
    try:
        await check_portals_version(component)
