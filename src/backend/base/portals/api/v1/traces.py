...
Business logic (query/aggregation) lives in:
    portals.services.tracing.repository

Data transformation logic lives in:
    portals.services.tracing.formatting
"""
...
from portals.services.tracing.repository import fetch_single_trace, fetch_traces
from portals.services.tracing.validation import sanitize_query_string
