...
from portals.api.v1.files import get_flow
...
from portals.events.event_manager import create_stream_tokens_event_manager
from portals.exceptions.api import APIException, InvalidChatInputError
from portals.exceptions.serialization import SerializationError
from portals.helpers.flow import get_flow_by_id_or_endpoint_name
from portals.interface.initialize.loading import update_params_with_load_from_db_fields
from portals.processing.process import process_tweaks, run_graph_internal
from portals.schema.graph import Tweaks
...
from portals.services.cache.utils import save_uploaded_file
from portals.services.database.models.flow.model import Flow, FlowRead
from portals.services.database.models.flow.utils import (
...
from portals.services.event_manager import (
    create_webhook_event_manager,
    webhook_event_manager,
)
from portals.services.telemetry.schema import RunPayload
...
async def simplified_run_flow(
    *,
    ...
    Notes:
        ...
        - Extracts global variables from HTTP headers with prefix X-PORTALS-GLOBAL-VAR-*
...
# get endpoint to return version of portals
@router.get("/version")
