...
from portals.api.utils import normalize_flow_for_export, remove_api_keys
from portals.services.database.models.base import orjson_dumps
from portals.services.database.models.deployment.orm_guards import ensure_flow_move_allowed
...
from portals.services.database.models.flow.utils import get_webhook_component_in_flow
from portals.services.database.models.folder.model import Folder
from portals.services.database.models.folder.utils import get_default_folder_id
...
def _build_flows_download_response(
    ...
    if len(normalised_flows) > 1:
        ...
        filename = f"{current_time}_portals_flows.zip"
