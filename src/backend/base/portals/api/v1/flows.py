...
from px.services.cache.utils import CACHE_MISS
...
from portals.api.utils.zip_utils import extract_flows_from_zip
from portals.api.v1.flows_helpers import (
...
from portals.api.v1.mappers.deployments.sync import retry_flow_operation_on_deployment_guard
from portals.api.v1.schemas import FlowListCreate
from portals.helpers.user import get_user_by_flow_id_or_endpoint_name
...
from portals.services.cache.service import ThreadingInMemoryCache
from portals.services.database.models.deployment.exceptions import (
    araise_if_deployment_guard_error_or_skip,
)
from portals.services.database.models.flow.model import (
    AccessTypeEnum,
    Flow,
    FlowCreate,
    FlowHeader,
...
from portals.services.database.models.folder.constants import DEFAULT_FOLDER_NAME
...
from portals.utils.compression import compress_response

# Re-export helpers so existing ``from portals.api.v1.flows import ...`` still works.
__all__ = [
    "_get_safe_flow_path",
    "_new_flow",
    "_read_flow",
...
async def expand_compact_flow_endpoint(
    ...
    from px.interface.components import component_cache, get_and_cache_all_types_dict

    from portals.processing.expand_flow import expand_compact_flow
