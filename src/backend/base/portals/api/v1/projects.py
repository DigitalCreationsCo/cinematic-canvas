...
from portals.api.v1.mappers.deployments.sync import (
    retry_flow_operation_on_deployment_guard,
    retry_project_operation_on_deployment_guard,
)
from portals.api.v1.mcp_projects import register_project_with_composer
from portals.api.v1.projects_files import download_project_flows, upload_project_flows
from portals.api.v1.projects_mcp_helpers import (
    cleanup_mcp_on_delete,
    handle_mcp_server_rename,
    register_mcp_servers_for_project,
)
from portals.initial_setup.constants import ASSISTANT_FOLDER_NAME, STARTER_FOLDER_NAME
from portals.services.auth.mcp_encryption import encrypt_auth_settings
from portals.services.database.models.deployment.exceptions import (
    araise_if_deployment_guard_error_or_skip,
    remap_flow_guard_for_project_delete,
)
from portals.services.database.models.deployment.guards import (
...
from portals.services.database.models.folder.model import (
    Folder,
    FolderCreate,
    FolderRead,
    FolderReadWithFlows,
...
from portals.services.database.models.folder.pagination_model import (
        ...
        async def _move_flows_into_project() -> None:
            if project.components_list:
                ...
                update_statement_components = (
                    update(Flow)
                    .where(
                        Flow.id.in_(project.components_list),
                        Flow.user_id == current_user.id,
