...
# Carries per-request variables injected via HTTP headers (e.g., X-Portals-Global-Var-*)
...
async def handle_read_resource(uri: str, project_id: UUID | str | None = None) -> bytes:
    ...
    try:
        ...
        # not enough because the filesystem doesn't know about Portals users, and
