...
from portals.schema import (
    OpenAIErrorResponse,
    OpenAIResponsesRequest,
    OpenAIResponsesResponse,
    OpenAIResponsesStreamChunk,
)
from portals.schema.content_types import ToolContent
...
from portals.services.telemetry.service import TelemetryService
    ...
    *,
    ...
    if stream:
        ...
        async def openai_stream_generator() -> AsyncGenerator[str, None]:
            """Convert Portals events to OpenAI Responses API streaming format."""
...
async def create_response(
    ...
    the input through the specified Portals flow.
    ...
    # Extract global variables from X-PORTALS-GLOBAL-VAR-* headers
