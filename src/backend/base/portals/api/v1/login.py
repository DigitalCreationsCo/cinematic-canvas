...
from portals.api.v1.schemas import Token
...
from portals.services.deps import get_auth_service, get_settings_service, get_variable_service
...
async def get_session(
    ...
    """
    from portals.services.auth.utils import oauth2_login
