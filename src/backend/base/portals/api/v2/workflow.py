...
from px.schema.workflow import (
...
from px.services.deps import get_settings_service, injectable_session_scope_readonly
...
from portals.api.v2.converters import (
    create_error_response,
    parse_flat_inputs,
    run_response_to_workflow_response,
)
from portals.api.v2.workflow_reconstruction import reconstruct_workflow_response_from_job_id
from portals.exceptions.api import (
...
from portals.services.auth.utils import api_key_security
from portals.services.database.models.flow.model import FlowRead
from portals.services.database.models.jobs.model import JobType
from portals.services.database.models.user.model import UserRead
from portals.services.deps import get_job_service, get_task_service
...
async def execute_sync_workflow(
    ...
    # Headers with prefix X-PORTALS-GLOBAL-VAR-* are extracted and made available to components
