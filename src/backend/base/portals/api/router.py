...
from portals.api.v2 import files_router as files_router_v2
from portals.api.v2 import mcp_router as mcp_router_v2
from portals.api.v2 import registration_router as registration_router_v2
from portals.api.v2 import workflow_router as workflow_router_v2
...
def include_deployment_router(target_router: APIRouter) -> None:
    ...
    if FEATURE_FLAGS.wxo_deployments:
        from portals.api.v1.deployments import router as deployment_router

        target_router.include_router(deployment_router)


router_v1.include_router(chat_router)
router_v1.include_router(canvas_router)
...
def _include_agentic_router():
    from portals.agentic.api.router import router as agentic_router
