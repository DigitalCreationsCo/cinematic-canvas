...
from portals.services.deps import get_chat_service
...
# it means uvicorn's /health serves first before the portals instance is up
# therefore it's not a reliable health check for a portals instance
...
# It's a reliable health check for a portals instance
