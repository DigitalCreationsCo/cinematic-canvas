...
from portals.schema.schema import INPUT_FIELD_NAME
...
async def flow_function({func_args}):
    tweaks = {{ {arg_mappings} }}
    from portals.helpers.flow import run_flow
    from langchain_core.tools import ToolException
    from px.base.flow_processing.utils import build_data_from_result_data, format_flow_output_data
    try:
