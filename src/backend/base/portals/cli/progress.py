...
def create_portals_progress(*, verbose: bool = False) -> ProgressIndicator:
    """Create a progress indicator with predefined Portals initialization steps."""
    progress = ProgressIndicator(verbose=verbose)

    # Define the initialization steps matching the order in main.py
    steps = [
        ("Initializing Portals", "Setting up basic configuration"),
        ...
        ("Launching Portals", "Starting server and final setup"),
    ]
...
def create_portals_shutdown_progress(*, verbose: bool = False, multiple_workers: bool = False) -> ProgressIndicator:
    """Create a progress indicator with predefined Portals shutdown steps."""
    progress = ProgressIndicator(verbose=verbose)
