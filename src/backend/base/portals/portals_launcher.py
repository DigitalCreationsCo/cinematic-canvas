...
def main():
    """Launches portals with appropriate environment setup.
    ...
    if platform.system() == "Darwin":  # macOS
        ...
        from portals.__main__ import main as portals_main

        portals_main()


def _launch_with_exec():
    """Launch portals by replacing current process with properly configured environment.
