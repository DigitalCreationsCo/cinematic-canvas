...
from px.log.logger import InterceptHandler
from uvicorn.workers import UvicornWorker


class PortalsUvicornWorker(UvicornWorker):
...
class PortalsApplication(BaseApplication):
    def __init__(self, app, options=None) -> None:
        self.options = options or {}

        self.options["worker_class"] = "portals.server.PortalsUvicornWorker"
