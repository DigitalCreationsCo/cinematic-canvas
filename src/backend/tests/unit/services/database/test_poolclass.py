...
Issue: https://github.com/portals-ai/portals/issues/10231
PR: https://github.com/portals-ai/portals/pull/10232
...
class TestBuggyCode:
    ...
    def test_buggy_code_crashes_with_nullpool(self):
        ...
        When users set PORTALS_DB_CONNECTION_SETTINGS={"poolclass": "NullPool"},
