"""Unit tests for portals.services.tracing.formatting.
...
from portals.services.database.models.traces.model import SpanStatus, SpanTable, SpanType
from portals.services.tracing.formatting import (
...
class TestExtractTraceIoFromSpans:
    ...
    def test_should_match_chat_input_span_by_substring(self):
        ...
        span = _span(
            name=f"Portals {_CHAT_INPUT_SPAN_NAME} Component",
