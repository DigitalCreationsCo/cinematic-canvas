...
from portals.schema.content_block import ContentBlock
from portals.schema.content_types import TextContent, ToolContent
from portals.schema.message import MAX_ATTACHMENT_SIZE_BYTES, Message
from portals.schema.properties import Properties, Source

# Assuming you have these imports available
from portals.services.database.models.message import MessageCreate, MessageRead
from portals.services.database.models.message.model import MessageTable
from portals.services.deps import session_scope
from portals.services.tracing.utils import convert_to_langchain_type
...
class TestMessageResponseFromMessage:
    ...
    def test_from_message_missing_required_raises_error(self):
        ...
        from px.schema.message import MessageResponse
...
class TestSanitizeJson:
    ...
    def test_from_message_with_nan_in_properties(self):
        ...
        from portals.schema.properties import Properties
        from portals.services.database.models.message.model import MessageTable
