...
from px.components.input_output.chat_output import ChatOutput
...
class TestComponentToolEventEmission:
    ...
    def test_emits_build_events_with_correct_structure(self):
        ...
        from px.events.event_manager import create_default_event_manager
...
class TestComponentToolAsyncEventEmission:
    ...
    async def test_async_emits_build_end_event(self):
        ...
        from px.base.tools.component_tool import _build_output_async_function
        from px.events.event_manager import create_default_event_manager
