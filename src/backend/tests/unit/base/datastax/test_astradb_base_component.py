...
from px.base.datastax import AstraDBBaseComponent
...
class TestCloudProviderMapping:
    ...
    @patch("px.base.datastax.astradb_base.DataAPIClient")
...
class TestCollectionCreation:
    ...
    @pytest.mark.asyncio
    @patch("px.base.datastax.astradb_base._AstraDBCollectionEnvironment")
