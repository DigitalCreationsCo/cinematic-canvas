...
from portals.api.utils import get_suggestion_message, remove_api_keys
...
def test_get_outdated_components():
    ...
    with patch(
        "portals.services.database.models.flow.utils.get_components_versions", return_value=mock_component_versions
    ):
