...
from portals.api.v1.mappers.deployments import get_mapper
...
from px.services.adapters.payload import AdapterPayloadValidationError, PayloadSlot
...
def test_watsonx_mapper_trusts_top_level_deployment_id() -> None:
    ...
    from px.services.adapters.deployment.schema import ExecutionStatusResult
...
def test_wxo_mapper_verify_credentials_create_filters_non_credential_fields() -> None:
    ...
    from portals.api.v1.schemas.deployments import DeploymentProviderAccountCreateRequest
...
def test_wxo_mapper_update_allows_name_changes_only_for_non_credential_fields() -> None:
    ...
    from portals.api.v1.schemas.deployments import DeploymentProviderAccountUpdateRequest
...
def test_wxo_mapper_resolve_verify_credentials_rejects_extra_fields() -> None:
    ...
    from portals.services.adapters.deployment.watsonx_orchestrate.payloads import PAYLOAD_SCHEMAS
    from px.services.adapters.payload import AdapterPayloadValidationError
...
def test_watsonx_created_tool_includes_tool_id() -> None:
    ...
    from portals.api.v1.mappers.deployments.watsonx_orchestrate.payloads import WatsonxApiCreatedTool
