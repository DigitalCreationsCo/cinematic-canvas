...
from px.base.models.unified_models import get_model_provider_variable_mapping
...
async def test_enabled_providers_after_credential_creation(client: AsyncClient, openai_credential, logged_in_headers):
    ...
    with mock.patch("portals.api.v1.variable.validate_model_provider_key") as mock_validate:
    ...
    with mock.patch("px.base.models.unified_models.validate_model_provider_key") as mock_validate:
...
async def test_list_models_returns_live_ollama_models_when_configured(client: AsyncClient, logged_in_headers):
    ...
    with (
        mock.patch(
            "portals.api.v1.models.get_enabled_providers",
            side_effect=mock_get_enabled_providers,
        ),
        mock.patch(
            "px.base.models.model_utils.get_live_models_for_provider",
