...
from portals.api.utils.kb_helpers import (
    KBAnalysisHelper,
    KBIngestionHelper,
    KBStorageHelper,
)
...
class TestGetKBMetaData:
    ...
    @patch("portals.api.utils.kb_helpers.KBStorageHelper.get_directory_size")
    @patch("portals.api.utils.kb_helpers.KBAnalysisHelper.update_text_metrics")
    ...
    @patch("portals.api.utils.kb_helpers.KBAnalysisHelper._detect_embedding_provider")
    @patch("portals.api.utils.kb_helpers.KBAnalysisHelper._detect_embedding_model")
    @patch("portals.api.utils.kb_helpers.KBStorageHelper.get_directory_size")
...
class TestKnowledgeBaseAPI:
    ...
    @patch("portals.api.v1.knowledge_bases.KBStorageHelper.get_fresh_chroma_client")
    @patch("portals.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
    ...
    @patch("portals.api.v1.knowledge_bases.logger.warning")
    @patch("portals.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
    ...
    @patch("portals.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
    @patch("portals.api.v1.knowledge_bases.KBAnalysisHelper.get_metadata")
    @patch("portals.api.v1.knowledge_bases.get_job_service")
    ...
    @patch("portals.api.utils.kb_helpers.KBStorageHelper.delete_storage", return_value=True)
    @patch("portals.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
    ...
    @patch("portals.api.v1.knowledge_bases.logger")
    @patch("portals.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
    ...
    @patch("portals.api.v1.knowledge_bases.KBAnalysisHelper.get_metadata")
    @patch("portals.api.v1.knowledge_bases.get_job_service")
    @patch("portals.api.v1.knowledge_bases.get_task_service")
    ...
    @patch("portals.api.v1.knowledge_bases.KBStorageHelper.get_fresh_chroma_client")
    @patch("portals.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
    @patch("portals.api.v1.knowledge_bases.Chroma")
...
class TestPerformIngestionTask:
    ...
    @patch("portals.api.utils.kb_helpers.KBStorageHelper.get_fresh_chroma_client")
    @patch("portals.api.utils.kb_helpers.Chroma")
    @patch("portals.api.utils.kb_helpers.KBIngestionHelper._build_embeddings", new_callable=AsyncMock)
    @patch("portals.api.utils.kb_helpers.KBAnalysisHelper.get_metadata")
    @patch("portals.api.utils.kb_helpers.KBStorageHelper.get_directory_size")
    @patch("portals.api.utils.kb_helpers.KBAnalysisHelper.update_text_metrics")
    ...
    @patch("portals.api.utils.kb_helpers.Chroma")
    @patch("portals.api.utils.kb_helpers.KBIngestionHelper._build_embeddings", new_callable=AsyncMock)
    @patch("portals.api.utils.kb_helpers.KBIngestionHelper.cleanup_chroma_chunks_by_job", new_callable=AsyncMock)
...
class TestCancelIngestion:
    ...
    @patch("portals.api.v1.knowledge_bases.KBIngestionHelper.cleanup_chroma_chunks_by_job")
    @patch("portals.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
    @patch("portals.api.v1.knowledge_bases.KBAnalysisHelper.get_metadata")
    async def test_cancel_ingestion_success(
        ...
        with mock_patch("portals.services.deps.get_service", side_effect=get_service_side_effect):
            response = await client.post(
