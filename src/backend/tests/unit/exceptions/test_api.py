...
from portals.exceptions.api import APIException, ExceptionBody
...
def test_api_exception():
    ...
    with (
        patch(
            "portals.services.database.models.flow.utils.get_outdated_components",
            return_value=mock_outdated_components,
        ),
        patch("portals.api.utils.get_suggestion_message", return_value=mock_suggestion_message),
        patch(
            "portals.services.database.models.flow.utils.get_components_versions",
