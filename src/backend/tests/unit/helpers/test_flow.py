"""Unit tests for the portals.helpers.flow module."""
...
_PORTALS_HELPER_MODULE_FLOW = "portals.helpers.flow"
...
class TestDynamicImport:
    """Test dynamic imports of the portals implementation."""

    def test_portals_available(self):
        """Test whether the portals implementation is available."""
        # Portals implementation should be available
        if not has_portals_memory():
            pytest.fail("Portals implementation is not available")
    ...
    def test_helpers_import_build_schema_from_inputs(self):
        ...
        try:
            ...
            pytest.fail(f"Failed to dynamically import px.helpers.build_schema_from_inputs: {e}")

        # Helper module should be the portals implementation
        assert is_helper_module(build_schema_from_inputs, _PORTALS_HELPER_MODULE_FLOW)
    ...
    def test_helpers_import_get_arg_names(self):
        ...
        # Helper module should be the portals implementation
        assert is_helper_module(get_arg_names, _PORTALS_HELPER_MODULE_FLOW)
    ...
    def test_helpers_import_get_flow_inputs(self):
        ...
        # Helper module should be the portals implementation
        assert is_helper_module(get_flow_inputs, _PORTALS_HELPER_MODULE_FLOW)
    ...
    def test_helpers_import_list_flows(self):
        ...
        # Helper module should be the portals implementation
        assert is_helper_module(list_flows, _PORTALS_HELPER_MODULE_FLOW)
    ...
    def test_helpers_import_load_flow(self):
        ...
        # Helper module should be the portals implementation
        assert is_helper_module(load_flow, _PORTALS_HELPER_MODULE_FLOW)
    ...
    def test_helpers_import_run_flow(self):
        ...
        # Helper module should be the portals implementation
        assert is_helper_module(run_flow, _PORTALS_HELPER_MODULE_FLOW)
