"""Unit tests for portals.core.celeryconfig module."""

# Import the module to test
from portals.core import celeryconfig
...
class TestCeleryConfigVariables:
    ...
    def test_required_config_variables_exist(self):
        ...
        for var in required_vars:
            assert hasattr(celeryconfig, var), (
    ...
    def test_broker_url_format(self):
        ...
        assert broker_url.startswith(("redis://", "amqp://")), (
            f"Unexpected broker_url format: {broker_url}"
        )
    ...
    def test_result_backend_format(self):
        ...
        assert result_backend.startswith("redis://"), (
            f"Unexpected result_backend format: {result_backend}"
        )
