...
from px.base.models.unified_models.build_config import _resolve_dropdown_provider_values
...
@patch("px.base.models.unified_models.model_catalog._fetch_enabled_providers_for_user", new_callable=AsyncMock)
@patch("px.base.models.unified_models.model_catalog._get_model_status", new_callable=AsyncMock)
...
@patch("px.base.models.unified_models.get_api_key_for_provider")
@patch("px.base.models.unified_models.get_embedding_class")
@patch("px.base.models.unified_models.get_all_variables_for_provider")
...
def test_handle_model_input_update_uses_language_model_options_by_default():
    ...
    with patch("px.base.models.unified_models.get_language_model_options") as mock_opts:
...
def test_handle_model_input_update_calls_apply_provider_config_when_model_selected():
    ...
    with patch("px.base.models.unified_models.apply_provider_variable_config_to_build_config") as mock_apply:
...
@patch("px.base.models.unified_models.build_config.logger.debug")
...
def test_handle_model_input_update_resolves_watsonx_dropdown():
    ...
    with patch("px.base.models.unified_models.get_all_variables_for_provider") as mock_get_vars:
        mock_get_vars.return_value = {"WATSONX_URL": "https://eu-de.ml.cloud.ibm.com"}
...
def test_get_provider_for_model_name_backwards_compat():
    ...
    ``px.base.models.unified_models``. The post-refactor package split broke
    that import; this test guards against reintroducing the regression.
    """
    from px.base.models.unified_models import get_provider_for_model_name
