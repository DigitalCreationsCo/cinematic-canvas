from portals.processing.process import process_tweaks
from portals.services.deps import get_session_service
from portals.services.utils import register_all_service_factories
...
def test_tweaks_schema_accepts_bool():
    ...
    from px.schema.graph import Tweaks
...
def test_apply_tweaks_code_override_prevention():
    ...
    from portals.processing.process import apply_tweaks
    ...
    # Capture log output
    with patch("portals.processing.process.logger") as mock_logger:
