...
from px.components.serpapi.serp import SerpComponent
...
@patch("px.components.serpapi.serp.SerpAPIWrapper")
...
def test_error_handling():
    ...
    with patch("px.components.serpapi.serp.SerpAPIWrapper") as mock_serpapi:
        mock_instance = MagicMock()
