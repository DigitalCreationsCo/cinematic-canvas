...
class TestDoclingEmptyTextExtraction:
    ...
    @patch("px.components.files_and_knowledge.file.get_settings_service")
    ...
    @patch("px.base.data.base_file.get_settings_service")
    @patch("px.components.files_and_knowledge.file.get_settings_service")
    @patch("subprocess.Popen")
...
class TestStoragePathResolution:
    ...
    @patch("px.custom.custom_component.custom_component.get_storage_service")
    @patch("px.base.data.base_file.get_settings_service")
...
class TestImageContentTypeValidation:
    ...
    def test_valid_png_file(self, tmp_path):
        ...
        from px.base.data.storage_utils import validate_image_content_type
