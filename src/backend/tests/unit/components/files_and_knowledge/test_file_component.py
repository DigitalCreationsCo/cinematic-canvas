...
class TestFileComponentToolMode:
    ...
    @patch("px.base.data.cloud_storage_utils.create_s3_client")
    @patch("px.base.data.cloud_storage_utils.validate_aws_credentials")
    ...
    @patch("px.base.data.cloud_storage_utils.create_google_drive_service")
