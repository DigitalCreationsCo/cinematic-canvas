...
from px.components.langchain_utilities.ibm_granite_handler import (
    PLACEHOLDER_PATTERN,
...
class TestCreateGraniteAgentDynamicInvoke:
    ...
    def test_uses_required_for_first_iteration(self):
        ...
        with (
            patch("px.components.langchain_utilities.ibm_granite_handler.format_to_tool_messages", return_value=[]),
...
class TestToolCallingAgentIntegration:
    ...
    def test_watsonx_detection_in_create_agent_runnable(self):
        ...
        from px.components.langchain_utilities import ToolCallingAgentComponent
        ...
        with (
            ...
            patch("px.components.langchain_utilities.tool_calling.create_granite_agent") as mock_create,
        ):
    ...
    def test_watsonx_llama_uses_default_agent(self):
        ...
        with (
            patch.object(component, "_get_llm", return_value=mock_llm),
            patch("px.components.langchain_utilities.tool_calling.create_tool_calling_agent") as mock_default,
        ):
    ...
    def test_non_watsonx_uses_default_agent(self):
        ...
        with (
            patch.object(component, "_get_llm", return_value=mock_llm),
            patch("px.components.langchain_utilities.tool_calling.create_tool_calling_agent") as mock_create,
        ):
            mock_create.return_value = Mock()
