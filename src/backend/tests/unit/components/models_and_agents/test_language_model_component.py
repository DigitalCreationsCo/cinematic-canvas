...
from px.base.models.google_generative_ai_constants import GOOGLE_GENERATIVE_AI_MODELS
from px.base.models.openai_constants import OPENAI_REASONING_MODEL_NAMES
from px.components.models_and_agents import LanguageModelComponent
...
class TestLanguageModelComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("px.base.models.unified_models.get_api_key_for_provider", return_value=None)
    ...
    @patch("px.base.models.unified_models.get_language_model_options")
