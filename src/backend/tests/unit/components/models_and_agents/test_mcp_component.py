...
import pytest
from px.base.mcp.util import MCPSessionManager, MCPStdioClient, MCPStreamableHttpClient
from px.components.models_and_agents.mcp_component import MCPToolsComponent
from px.inputs.inputs import BoolInput, MessageTextInput, NestedDictInput
...
class TestMCPComponentConfigPriority:
    ...
    async def test_database_config_takes_priority_over_value(self, component):
        ...
        with (
            ...
            patch("portals.services.database.models.user.crud.get_user_by_id") as mock_get_user,
            patch("px.components.models_and_agents.mcp_component.session_scope"),
...
def test_resolve_config_db_takes_priority():
    ...
    from px.components.models_and_agents.mcp_component import resolve_mcp_config
...
async def test_config_priority_with_fixtures(mock_db_session_with_servers):
    ...
    with (
        ...
        patch("portals.services.database.models.user.crud.get_user_by_id") as mock_get_user,
        patch(
            "px.components.models_and_agents.mcp_component.session_scope",
