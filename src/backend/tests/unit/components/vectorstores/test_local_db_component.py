...
import pytest
from portals.services.cache.utils import CACHE_DIR
from px.components.vectorstores.local_db import LocalDBComponent
...
class TestLocalDBComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("px.components.vectorstores.local_db.LocalDBComponent.list_existing_collections")
