...
from px.base.embeddings.embeddings_class import EmbeddingsWithModels
from px.components.elastic.opensearch_multimodal import (
...
class TestOpenSearchMultimodalComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("px.components.elastic.opensearch_multimodal.OpenSearch")
