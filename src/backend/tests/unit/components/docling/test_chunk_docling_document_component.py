...
from px.components.docling.chunk_docling_document import ChunkDoclingDocumentComponent
...
class TestChunkDoclingDocumentComponentHybridChunker:
    def _run_chunk_documents_with_mocks(
        ...
        monkeypatch.setattr(
            "px.components.docling.chunk_docling_document.HierarchicalChunker",
            DummyHierarchicalChunker,
        )
        monkeypatch.setattr(
            "px.components.docling.chunk_docling_document.extract_docling_documents",
