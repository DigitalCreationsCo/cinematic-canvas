...
from px.components.docling.export_docling_document import ExportDoclingDocumentComponent
...
class TestExportDoclingDocumentMetadata:
    ...
    def _run_export(self, monkeypatch, fake_doc, export_format="Markdown"):
        ...
        monkeypatch.setattr(
            "px.components.docling.export_docling_document.extract_docling_documents",
