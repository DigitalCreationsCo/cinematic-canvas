"""Unit tests for Agentics AgenerateComponent (formerly SyntheticDataGenerator)."""
...
from px.components.agentics.agenerate_component import AgenerateComponent


@pytest.mark.unit
class TestAgenerateComponent:
    """Tests for AgenerateComponent metadata."""
    ...
    def test_should_have_correct_description(self):
        ...
        assert "mock data" in AgenerateComponent.description.lower()
        assert "schema" in AgenerateComponent.description.lower()
    ...
    def test_should_have_model_input_with_real_time_refresh(self):
        ...
        model_input = next((i for i in AgenerateComponent.inputs if i.name == "model"), None)
    ...
    def test_should_have_schema_with_table_schema(self):
        ...
        schema_input = next((i for i in AgenerateComponent.inputs if i.name == "schema"), None)
    ...
    def test_should_have_batch_size_with_default_value(self):
        ...
        batch_input = next((i for i in AgenerateComponent.inputs if i.name == "batch_size"), None)
    ...
    def test_should_have_api_key_as_advanced(self):
        ...
        api_key_input = next((i for i in AgenerateComponent.inputs if i.name == "api_key"), None)
    ...
    def test_should_have_output_with_correct_method(self):
        ...
        output = next((o for o in AgenerateComponent.outputs if o.name == "states"), None)
