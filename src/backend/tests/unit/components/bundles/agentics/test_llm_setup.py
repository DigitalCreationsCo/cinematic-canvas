...
class TestPrepareLlmFromComponent:
    ...
    @patch("px.components.agentics.helpers.llm_setup.create_llm")
    @patch("px.components.agentics.helpers.llm_setup.get_api_key_for_provider")
    @patch("px.components.agentics.helpers.llm_setup.validate_model_selection")
    def test_should_call_validate_model_selection_with_component_model(
        ...
        from px.components.agentics.helpers.llm_setup import prepare_llm_from_component
