...
from px.base.langwatch.utils import get_cached_evaluators
from px.components.langwatch.langwatch import LangWatchComponent
...
class TestLangWatchComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("px.components.langwatch.langwatch.httpx.get")
