...
def test_should_import_module_when_jq_not_installed(monkeypatch):
    ...
    monkeypatch.delitem(sys.modules, "px.components.processing.data_operations", raising=False)

    # This must NOT raise ModuleNotFoundError
    mod = importlib.import_module("px.components.processing.data_operations")
