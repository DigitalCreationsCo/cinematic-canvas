...
import pytest
from px.components.ollama.ollama_embeddings import OllamaEmbeddingsComponent
...
class TestOllamaEmbeddingsComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("px.components.ollama.ollama_embeddings.OllamaEmbeddings")
    ...
    @patch("px.components.ollama.ollama_embeddings.OllamaEmbeddings")
    @patch("px.components.ollama.ollama_embeddings.logger")
    ...
    @pytest.mark.asyncio
    @patch("px.components.ollama.ollama_embeddings.httpx.AsyncClient.post")
    @patch("px.components.ollama.ollama_embeddings.httpx.AsyncClient.get")
