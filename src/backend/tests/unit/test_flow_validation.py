"""Tests for flow validation utilities (px.utils.flow_validation).
...
class TestBuildCodeHashLookups:
    """Tests for _build_code_hash_lookups in px.interface.components."""

    def test_populates_hash_lookups_from_all_types_dict(self):
        from px.interface.components import ComponentCache, _build_code_hash_lookups
