...
import pytest
from portals.agentic.helpers.code_extraction import (
    _find_code_blocks,
...
INCOMPLETE_COMPONENT_CODE = """from portals.custom import Component
from portals.io import MessageTextInput, Output
...
INVALID_SYNTAX_CODE = """from portals.custom import Component
...
class TestExtractPythonCode:
    ...
    def test_extract_from_closed_python_block(self):
        ...
        assert "from portals.custom import Component" in result
...
```"""
    ...
    def test_handles_code_with_special_characters(self):
        ...
        code_with_specials = """from portals.custom import Component
...
class TestEdgeCases:
    ...
    def test_handles_unicode_in_code(self):
        ...
        unicode_code = """from portals.custom import Component
...
class TestValidateComponentCode:
    ...
    def test_validates_valid_component(self):
        """Should validate correct Portals component code."""
    ...
    def test_fails_for_non_component_code(self):
        """Should fail validation for code that's not a Portals component."""
...
```"""
        ...
        assert (
            "expected" in validation.error.lower()
...
Based on your request, I'll create a custom Portals component that performs sentiment analysis.
This component will:
1. Take text input
