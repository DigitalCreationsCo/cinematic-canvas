...
from portals.agentic.helpers.input_sanitization import (
    REFUSAL_MESSAGE,
    sanitize_input,
)
...
class TestSanitizeInputCleanInputs:
    """Tests that legitimate Portals questions pass sanitization."""

    def test_should_pass_normal_portals_question(self):
        """Normal Portals question should pass."""
        result = sanitize_input("How do I create a component in Portals?")
    ...
    def test_should_pass_system_in_legitimate_context(self):
        ...
        result = sanitize_input("How do I configure system settings in Portals?")
        assert result.is_safe is True

    def test_should_pass_portuguese_question(self):
        """Portuguese Portals question should pass."""
        result = sanitize_input("Como criar um fluxo no Portals?")
        assert result.is_safe is True
...
class TestRefusalMessage:
    ...
    def test_refusal_message_mentions_portals(self):
        """Refusal message should mention Portals to redirect the user."""
        assert "Portals" in REFUSAL_MESSAGE
