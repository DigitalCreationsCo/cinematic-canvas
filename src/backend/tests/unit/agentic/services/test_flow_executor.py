...
from portals.agentic.services.helpers.event_consumer import parse_event_data
from px.utils.flow_validation import CustomComponentValidationError

MODULE = "portals.agentic.services.flow_executor"
...
class TestExecuteFlowFile:
    ...
    async def test_should_raise_400_for_custom_component_validation_error(self):
        ...
        with (
            patch(
                "portals.agentic.services.flow_executor.resolve_flow_path",
                return_value=(Path("/fake/path/test.py"), "python"),
            ),
            patch(
                "portals.agentic.services.flow_executor.load_graph_for_execution",
...
class TestExecuteFlowFileStreamingEvents:
    ...
    async def test_should_carry_original_error_internally_without_leaking_in_http_detail(self):
        ...
        """
        from portals.agentic.services.flow_types import FlowExecutionError
