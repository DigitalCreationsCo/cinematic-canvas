...
class TestConstants:
    ...
    def test_portals_assistant_flow_should_be_string(self):
        """PORTALS_ASSISTANT_FLOW should be a non-empty string."""
        assert isinstance(PORTALS_ASSISTANT_FLOW, str)
        assert len(PORTALS_ASSISTANT_FLOW) > 0
