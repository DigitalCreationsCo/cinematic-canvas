...
from portals.serialization.constants import MAX_ITEMS_LENGTH, MAX_TEXT_LENGTH
from portals.serialization.serialization import serialize, serialize_or_str
