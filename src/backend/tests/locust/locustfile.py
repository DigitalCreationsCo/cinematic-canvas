...
class FlowRunUser(FastHttpUser):
    """FlowRunUser simulates users sending requests to the Portals run endpoint.
    ...
    def run_flow_endpoint(self):
        ...
        payload = {
            "input_value": (
                "Hey, Could you check https://docs.portals.org for me? Later, could you calculate 1390 / 192 ?"
            ),
            "output_type": "chat",
            "input_type": "chat",
            "tweaks": {},
