...
class TestTelemetryPayloadValidation:
    ...
    def test_component_inputs_payload_creation_and_serialization(self):
        ...
        from portals.services.telemetry.schema import ComponentInputsPayload
    ...
    def test_version_payload_creation_and_serialization(self):
        ...
        assert payload.package == "portals"
...
class TestComponentInputTelemetry:
    ...
    def test_sensitive_field_types_constant(self):
        ...
        from px.inputs.input_mixin import SENSITIVE_FIELD_TYPES, FieldTypes
    ...
    def test_track_in_telemetry_field_exists(self):
        ...
        from px.inputs.inputs import BoolInput, IntInput, SecretStrInput, StrInput
    ...
    def test_component_payload_with_run_id_integration(self):
        ...
        from portals.services.telemetry.schema import ComponentInputsPayload, ComponentPayload
