...
import pytest
from px.components.cometapi.cometapi import CometAPIComponent
...
class TestCometAPIIntegration:
    ...
    @patch("px.components.cometapi.cometapi.ChatOpenAI")
    ...
    def test_fallback_behavior_integration(self, mock_get, component):
        ...
        from px.base.models.cometapi_constants import MODEL_NAMES
