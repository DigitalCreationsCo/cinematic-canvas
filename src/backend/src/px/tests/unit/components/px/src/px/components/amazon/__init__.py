...
if TYPE_CHECKING:
    from px.components.amazon.amazon_bedrock_embedding import AmazonBedrockEmbeddingsComponent
    from px.components.amazon.amazon_bedrock_model import AmazonBedrockComponent
    from px.components.amazon.s3_bucket_uploader import S3BucketUploaderComponent
