...
from px.base.models.model_utils import get_watsonx_embedding_models
from px.field_typing import Embeddings
from px.io import BoolInput, DropdownInput, IntInput, SecretStrInput, StrInput
...
class WatsonxEmbeddingsComponent(LCEmbeddingsModel):
    """PX component for IBM watsonx.ai embeddings."""
    ...
    def fetch_models(base_url: str) -> list[str]:
        ...
        """
        return get_watsonx_embedding_models(
            base_url, default_models=WatsonxEmbeddingsComponent._default_models
        )
