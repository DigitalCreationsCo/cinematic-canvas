...
from px.base.agents.agent import LCToolsAgentComponent
from px.base.models.model_input_constants import (
    ALL_PROVIDER_FIELDS,
...
from px.components.helpers import CurrentDateComponent
from px.components.langchain_utilities.tool_calling import ToolCallingAgentComponent
from px.components.models_and_agents.memory import MemoryComponent
from px.custom.custom_component.component import _get_component_toolkit
from px.custom.utils import update_component_build_config
from px.field_typing import Tool
from px.io import BoolInput, DropdownInput, IntInput, MultilineInput, Output
from px.log.logger import logger
from px.schema.dotdict import dotdict
from px.schema.message import Message

if TYPE_CHECKING:
    from px.schema.log import SendMessageFunctionType
...
class CugaComponent(ToolCallingAgentComponent):
    ...
    documentation: str = "https://docs.portals.org/bundles-cuga"
    icon = "bot"
    name = "Cuga"
    ...
    async def message_response(self) -> Message:
        ...
        try:
            from px.schema.content_block import ContentBlock
            from px.schema.message import MESSAGE_SENDER_AI
            ...
            from px.base.agents.events import process_agent_events
