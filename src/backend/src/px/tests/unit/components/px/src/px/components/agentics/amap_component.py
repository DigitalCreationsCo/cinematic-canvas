...
from px.components.agentics.helpers import (
    build_schema_fields,
    prepare_llm_from_component,
)
from px.components.agentics.inputs import (
    get_generated_fields_input,
    get_model_provider_inputs,
)
from px.components.agentics.inputs.base_component import BaseAgenticComponent
from px.io import (
    BoolInput,
    DataFrameInput,
    MessageTextInput,
...
class AMapComponent(BaseAgenticComponent):
    ...
    documentation: str = "https://docs.portals.org/bundles-agentics"
    icon = "Agentics"
