"""Tests for dynamic import refactor in portals components.
...
class TestComponentDynamicImports:
    ...
    def test_multiple_category_modules(self):
        ...
        import px.components.anthropic as anthropic_components
        import px.components.data as data_components
    ...
    def test_backward_compatibility(self):
        ...
        # These imports should work since portals is installed with dependencies
        ...
        from px.components import data
        ...
        from px.components import helpers
    ...
    def test_import_error_handling(self):
        ...
        import px.components.notdiamond as notdiamond_components

        # Patch the import_mod function directly
        with patch("px.components.notdiamond.import_mod") as mock_import_mod:
    ...
    def test_type_checking_imports(self):
        ...
        import px.components.searchapi as searchapi_components
...
class TestSpecialCases:
    ...
    def test_platform_specific_components(self):
        ...
        import px.components.nvidia as nvidia_components
