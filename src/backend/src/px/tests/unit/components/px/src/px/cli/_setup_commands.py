...
def register(app: typer.Typer) -> None:
    ...
    @app.command(
        name="init", help="Scaffold a new Flow DevOps project", rich_help_panel="Setup"
    )
    ...
    @app.command(
        name="login",
        help="Validate credentials against a remote Portals instance",
    ...
    def login_command_wrapper(
        ...
        """Test connectivity and authentication for a Portals environment (lazy-loaded)."""
