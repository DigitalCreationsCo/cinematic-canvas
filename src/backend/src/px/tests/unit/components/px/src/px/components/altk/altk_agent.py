...
class ALTKAgentComponent(ALTKBaseAgentComponent):
    ...
    documentation: str = "https://docs.portals.org/bundles-altk"
    icon = "zap"
    beta = True
    name = "ALTK Agent"
