...
from px.base.io.text import TextComponent
from px.io import BoolInput, MultilineInput, Output
...
class TextInputComponent(TextComponent):
    ...
    documentation: str = "https://docs.portals.org/text-input-and-output"
    icon = "type"
    name = "TextInput"
