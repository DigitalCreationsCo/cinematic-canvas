...
class TestWatsonxEmbeddingsComponent:
    ...
    def wx_embeddings_component(self):
        ...
        from px.components.ibm.watsonx_embeddings import WatsonxEmbeddingsComponent
    ...
    @patch("px.base.models.model_utils.requests.get")
    ...
    @patch("px.components.ibm.watsonx_embeddings.WatsonxEmbeddingsComponent.fetch_models")
    ...
    @patch("px.components.ibm.watsonx_embeddings.WatsonxEmbeddingsComponent.fetch_models")
    @patch("px.components.ibm.watsonx_embeddings.logger")
    ...
    @patch("px.components.ibm.watsonx_embeddings.WatsonxEmbeddings")
    ...
    @patch("px.components.ibm.watsonx_embeddings.SecretStr", MockSecretStr)
    @patch("px.components.ibm.watsonx_embeddings.WatsonxEmbeddings")
