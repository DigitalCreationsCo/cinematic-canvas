...
from px.helpers.data import data_to_text
from px.inputs.inputs import DropdownInput, HandleInput, IntInput, MessageTextInput, MultilineInput, TabInput
from px.memory import aget_messages, astore_message
...
from px.utils.component_utils import set_current_fields, set_field_display
from px.utils.constants import MESSAGE_SENDER_AI, MESSAGE_SENDER_NAME_AI, MESSAGE_SENDER_USER


class MemoryComponent(Component):
    display_name = "Message History"
    description = "Stores or retrieves stored chat messages from Portals tables or an external memory."
    documentation: str = "https://docs.portals.org/message-history"
    ...
    inputs = [
        ...
        HandleInput(
            ...
            input_types=["Memory"],
            info="Retrieve messages from an external memory. If empty, it will use the Portals tables.",
            advanced=True,
        ),
        DropdownInput(
            name="sender_type",
