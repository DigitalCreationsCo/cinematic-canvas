"""Default auth service for PX (no database/JWT; use Portals auth for full auth)."""
...
class AuthService(BaseAuthService):
    """Default PX auth service.

    No database, JWT, or API key validation. For full auth, configure
    auth_service = "portals.services.auth.service:AuthService" in px.toml.
    """
