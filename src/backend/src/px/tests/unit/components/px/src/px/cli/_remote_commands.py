...
def register(app: typer.Typer) -> None:
    ...
    @app.command(
        name="status", help="Compare local flow files against a remote Portals instance", rich_help_panel="Remote"
    )
    def status_command_wrapper(
        ...
        env: str | None = typer.Option(
            ...
            "--env",
            "-e",
            help="Environment name from .px/environments.yaml. Uses [defaults] if omitted.",
        ),
        ...
        target: str | None = typer.Option(
            None,
            "--target",
            help="Portals instance URL (inline override — skips config file lookup).",
        ),
        api_key: str | None = typer.Option(
            None,
            "--api-key",
            help="API key for the Portals instance (used with --target or to override config).",
        ),
        ...
        from px.cli.status import status_command
    ...
    @app.command(
        name="push",
        help="Push flow JSON to a remote Portals instance (upsert by stable ID)",
    ...
    def push_command_wrapper(
        ...
        env: str | None = typer.Option(
            ...
            "--env",
            "-e",
            help="Environment name from .px/environments.yaml. Use --target for inline configuration.",
        ),
        dir_path: str | None = typer.Option(
            None,
            "--dir",
        ...
        """Push Portals flows to a remote instance using stable IDs for upsert (lazy-loaded)."""
    ...
    @app.command(
        name="pull", help="Pull flows from a remote Portals instance to local files", rich_help_panel="Remote"
    )
    def pull_command_wrapper(
        ...
        """Pull and normalize flows from a remote Portals instance (lazy-loaded)."""
    ...
    def export_command_wrapper(
        ...
        env: str | None = typer.Option(
            ...
            "--env",
            "-e",
            help="Environment name from .px/environments.yaml (required for remote mode unless --target is used).",
        ),
        flow_id: str | None = typer.Option(
            None,
            "--flow-id",
        ...
        """Export and normalize Portals flow JSON for version control (lazy-loaded)."""
