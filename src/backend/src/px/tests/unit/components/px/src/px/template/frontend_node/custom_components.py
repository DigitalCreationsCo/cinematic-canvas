...
from px.template.frontend_node.base import FrontendNode
from px.template.template.base import Template

DEFAULT_CUSTOM_COMPONENT_CODE = """from px.custom import CustomComponent
