"""px pull -- fetch flows from a remote Portals instance to local files.

Downloads flows from a live Portals instance, normalizes them for version
...
Pull all flows in a named project::
    ...
    px pull --env staging --project "My RAG Pipeline"

Pull a single flow by UUID::

    px pull --env staging --flow-id <uuid>

Pull to a custom directory::

    px pull --env production --output-dir ./local-flows/
"""
