"""Constants for field typing used throughout px package."""
...
try:
    ...
    # and crashed `portals --version` on fresh Windows installs.
    class AgentExecutor:
        pass
...
# Import px schema types (avoid circular deps)
from px.schema.data import JSON, Data
from px.schema.dataframe import DataFrame, Table
