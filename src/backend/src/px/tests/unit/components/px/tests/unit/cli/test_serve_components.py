...
class TestGraphAnalysis:
    ...
    def test_generate_dynamic_run_description(self):
        ...
        with patch("px.cli.serve_app._analyze_graph_structure") as mock_analyze:
            ...
            assert "Execute the deployed PX graph" in description
...
class TestCommonFunctions:
    ...
    @patch("px.cli.common.load_flow_from_json")
    @pytest.mark.asyncio
...
def create_real_graph():
    """Helper function to create a real PX graph with nodes/edges for serve_app."""
...
class TestFastAPIAppCreation:
    ...
    def test_create_multi_serve_app_basic(self, tmp_path):
        ...
        with patch("px.cli.serve_app.verify_api_key"):
            ...
            assert app.title.startswith("PX Multi-Flow Server")
...
class TestFastAPIEndpoints:
    ...
    @patch("px.cli.common.execute_graph_with_capture")
    @patch("px.cli.common.extract_result_data")
...
class TestErrorHandling:
    ...
    def test_invalid_json_in_request(self, tmp_path):
        ...
        with patch("px.cli.serve_app.verify_api_key", return_value="test-key"):
            app = create_multi_serve_app(
                root_dir=tmp_path,
