...
from px.base.models.model_utils import get_watsonx_llm_models
...
class WatsonxAIComponent(LCModelComponent):
    """PX component for IBM watsonx.ai text/chat generation."""
    ...
    def fetch_models(base_url: str) -> list[str]:
        ...
        """
        return get_watsonx_llm_models(
            base_url, default_models=WatsonxAIComponent._default_models
        )
