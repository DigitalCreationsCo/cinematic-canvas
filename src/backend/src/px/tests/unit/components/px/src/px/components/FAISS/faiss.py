...
from px.io import BoolInput, HandleInput, IntInput, StrInput
...
class FaissVectorStoreComponent(LCVectorStoreComponent):
    ...
    inputs = [
        ...
        StrInput(
            ...
            info="Path to save the FAISS index. It will be relative to where Portals is running.",
        ),
    ...
    def resolve_path(path: str) -> str:
        """Resolve the path relative to the Portals root.
