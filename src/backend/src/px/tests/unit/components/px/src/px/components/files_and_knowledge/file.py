...
- ALL Docling parsing/export runs in a separate OS process to prevent memory
  growth and native library state from impacting the main Portals process.
...
from px.base.data.storage_utils import parse_storage_path, read_file_bytes, validate_image_content_type
from px.base.data.utils import TEXT_FILE_TYPES, parallel_load_data, parse_text_file_to_data
from px.inputs import SortableListInput
from px.inputs.inputs import DropdownInput, MessageTextInput, StrInput
...
from px.services.deps import get_settings_service, get_storage_service
...
class FileComponent(BaseFileComponent):
    ...
    def _read_from_aws_s3(self) -> list[BaseFileComponent.BaseFile]:
        ...
        from px.base.data.cloud_storage_utils import create_s3_client, validate_aws_credentials
