...
from px.base.datastax.astradb_base import AstraDBBaseComponent
...
from px.helpers.data import docs_to_data
from px.io import (
    BoolInput,
    DropdownInput,
    FloatInput,
...
from px.serialization import serialize
...
class AstraDBVectorStoreComponent(AstraDBBaseComponent, LCVectorStoreComponent):
    ...
    documentation: str = "https://docs.portals.org/bundles-datastax"
    name = "AstraDB"
    icon: str = "AstraDB"
    ...
    def build_vector_store(self):
        ...
        # Get Portals version and platform information
        ...
        try:
            vector_store = AstraDBVectorStore(
                ...
                ext_callers=[(f"{portals_prefix}portals", __version__)],
