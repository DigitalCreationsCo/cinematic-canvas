"""Tests for px.graph.flow_builder.builder and flow_to_spec_summary.

Uses the real component_index.json registry.
"""

from px.graph.flow_builder.builder import build_flow_from_spec
from px.graph.flow_builder.flow import flow_to_spec_summary
...
"""
        ...
        # Each node should have proper Portals structure
