"""Framework-agnostic deployment exceptions for PX deployment service.
...
class DeploymentServiceError(Exception):
    ...
    def __init__(
        self, message: str, *, error_code: str, cause: Exception | None = None
    ):
...
class CredentialResolutionError(AuthenticationError):
    ...
    def __init__(
        self,
        message: str = "Credentials resolution failed",
        *,
        cause: Exception | None = None,
    ):
        super().__init__(
            message, error_code="credentials_resolution_error", cause=cause
        )
...
class ResourceConflictError(DeploymentError):
    ...
    def __init__(
        ...
        *,
        ...
        self.resource_name = (
            str(resource_name).strip() or None if resource_name is not None else None
        )
...
class InvalidContentError(DeploymentError):
    ...
    def __init__(
        self,
        message: str = "Deployment request entity is unprocessable",
        *,
        cause: Exception | None = None,
    ):
...
class InvalidDeploymentOperationError(DeploymentError):
    ...
    def __init__(
        self,
        message: str = "Invalid deployment operation",
        *,
        cause: Exception | None = None,
    ):
        super().__init__(
            message, error_code="invalid_deployment_operation", cause=cause
        )
...
class RateLimitError(DeploymentError):
    ...
    def __init__(
        self,
        message: str = "Deployment operation rate limited",
        *,
        cause: Exception | None = None,
    ):
...
class DeploymentTimeoutError(DeploymentError):
    ...
    def __init__(
        self,
        message: str = "Deployment operation timed out",
        *,
        cause: Exception | None = None,
    ):
...
class ServiceUnavailableError(DeploymentError):
    ...
    def __init__(
        self,
        message: str = "Deployment provider is unavailable",
        *,
        cause: Exception | None = None,
    ):
        super().__init__(
            message, error_code="deployment_provider_unavailable", cause=cause
        )
...
class AuthSchemeError(AuthenticationError):
    ...
    def __init__(
        self,
        message: str = "No matching authentication scheme was found",
        *,
        cause: Exception | None = None,
    ):
...
class InvalidDeploymentTypeError(DeploymentError):
    ...
    def __init__(
        self,
        message: str = "Deployment type is malformed or unknown",
        *,
        cause: Exception | None = None,
    ):
...
class DeploymentNotConfiguredError(DeploymentError):
    ...
    The stub :class:`~px.services.adapters.deployment.service.DeploymentService` raises
...
def http_status_for_deployment_error(exc: DeploymentServiceError) -> int:
    ...
    Order mirrors the except-chain priority in the Portals route layer:
    ...
    *cause* to preserve the traceback chain for debugging.  Callers that
    ...
    if status_code == status.HTTP_401_UNAUTHORIZED:
        raise AuthenticationError(
            message=message, error_code="authentication_error", cause=cause
        ) from cause
    if status_code == status.HTTP_403_FORBIDDEN:
        raise AuthorizationError(
            message=message, error_code="authorization_error", cause=cause
        ) from cause
    ...
    if (
        "forbidden" in detail_lower
        or "permission" in detail_lower
        or "not allowed" in detail_lower
    ):
        raise AuthorizationError(
            message=message, error_code="authorization_error", cause=cause
        ) from cause
    ...
    raise DeploymentError(
        message=message, error_code="deployment_error", cause=cause
    ) from cause
