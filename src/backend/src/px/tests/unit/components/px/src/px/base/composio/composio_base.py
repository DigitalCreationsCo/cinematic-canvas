...
from px.base.mcp.util import create_input_schema_from_json_schema
...
from px.io.schema import flatten_schema, schema_to_portals_inputs
...
class ComposioBaseComponent(Component):
    ...
    def _validate_schema_inputs(self, action_key: str) -> list[InputTypes]:
        """Convert the JSON schema for *action_key* into Portals input objects."""
        ...
        try:
            ...
            # Additional safety check before calling schema_to_portals_inputs
            ...
            result = schema_to_portals_inputs(input_schema)
