...
from px.field_typing.constants import CUSTOM_COMPONENT_SUPPORTED_TYPES, DEFAULT_IMPORT_STRING
...
def create_class(code, class_name):
    ...
    code = code.replace("from portals import CustomComponent", "from portals.custom import CustomComponent")
    code = code.replace(
...
def get_default_imports(code_string):
    ...
    default_imports.update({name: getattr(portals_module, name) for name in necessary_imports})
