...
from px.base.data import BaseFileComponent
from px.base.data.docling_utils import _serialize_pydantic_model
from px.inputs import BoolInput, DropdownInput, HandleInput, StrInput
...
class DoclingInlineComponent(BaseFileComponent):
    ...
    def process_files(self, file_list: list[BaseFileComponent.BaseFile]) -> list[BaseFileComponent.BaseFile]:
        ...
        if importlib.util.find_spec("docling") is None:
            msg = (
                "Docling is an optional dependency. Install with `uv pip install 'portals[docling]'` or refer to the "
