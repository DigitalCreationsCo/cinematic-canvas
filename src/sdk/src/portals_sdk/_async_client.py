"""Async HTTP client for the Portals REST API.

Preferred usage via the short alias::

    from portals_sdk import AsyncClient
...
class AsyncPortalsClient(_ClientCommon):
    """Async client for the Portals REST API.
    ...
    async def run_background(
        ...
        *,
        ...
        Args:
            ...
            input_type: Portals input type (default ``"chat"``).
            output_type: Portals output type (default ``"chat"``).
    ...
    async def pull_project(
        ...
        *,
        ...
        .. note::
            ...
            :meth:`PortalsClient.pull_project` for details.
...
#: Short alias for :class:`AsyncPortalsClient`.
#:
#: Example::
#:
#:     from portals_sdk import AsyncClient
#:     async with AsyncClient("https://portals.example.com", api_key="...") as c:
#:         flows = await c.list_flows()
AsyncClient = AsyncPortalsClient
