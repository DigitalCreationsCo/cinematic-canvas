"""Pydantic models mirroring the Portals REST API request/response shapes."""
...
class Flow(BaseModel):
    """A flow returned by the Portals API."""
...
class Project(BaseModel):
    """A project (folder) returned by the Portals API."""
...
class RunOutput(BaseModel):
    ...
    def first_text(self) -> str | None:
        ...
        for component_out in self.outputs:
            ...
            # Standard Portals chat output: results -> message -> text
    ...
    def has_errors(self) -> bool:
        ...
        Adapted from ``WorkflowResponse.has_errors()`` in portals-ai/sdk
...
class RunResponse(BaseModel):
    ...
    def all_text_outputs(self) -> list[str]:
        ...
        """
        return [
            text for output in self.outputs if (text := output.first_text()) is not None
        ]

    # ------------------------------------------------------------------
    # WorkflowResponse-style helpers
    # (adapted from portals-ai/sdk, Janardan Singh Kavia, IBM Corp.,
    #  Apache 2.0 — https://github.com/portals-ai/sdk/pull/1)
    # ------------------------------------------------------------------
    ...
    def get_chat_output(self) -> str | None:
        ...
        convention from the Portals V2 SDK::
    ...
    def is_completed(self) -> bool:
        ...
        ``WorkflowResponse.is_completed()`` in portals-ai/sdk
        (Janardan Singh Kavia, IBM Corp., Apache 2.0).
        """
    ...
    def is_failed(self) -> bool:
        ...
        Adapted from ``WorkflowResponse.is_failed()`` in portals-ai/sdk
        (Janardan Singh Kavia, IBM Corp., Apache 2.0).
        """
    ...
    def is_in_progress(self) -> bool:
        ...
        Included for API parity with :class:`BackgroundJob` and the Portals
...
class StreamChunk(BaseModel):
    ...
    Events emitted by the Portals backend:
