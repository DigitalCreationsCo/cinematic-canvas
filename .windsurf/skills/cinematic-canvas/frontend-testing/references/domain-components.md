# Domain-Specific Component Testing for Portals

Patterns for testing Portals-specific components that have unique architectural concerns.

## Flow/Graph Components

Portals's flow editor is built on `@xyflow/react` (React Flow). These components require specific mocking strategies.
...
## Testing Tips for Portals Components
...
3. **data-testid conventions**: Portals uses `data-testid` extensively. Common patterns:
